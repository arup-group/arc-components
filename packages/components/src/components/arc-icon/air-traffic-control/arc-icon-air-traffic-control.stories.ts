...
import './arc-icon-air-traffic-control.js';

export default {
  title: 'Components/Icons/ArcIconAirTrafficControl',
  component: 'arc-icon-air-traffic-control',
  argTypes: {
    size: {
      control: 'select',
