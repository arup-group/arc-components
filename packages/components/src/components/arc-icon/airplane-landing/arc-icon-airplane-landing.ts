...
import styles from './arc-icon-airplane-landing.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-airplane-landing')
export default class ArcIconAirplaneLanding extends LitElement {
  /** @internal */
  static tag = 'arc-icon-airplane-landing';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconAirplaneLanding.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-airplane-landing": ArcIconAirplaneLanding;
  }
}
