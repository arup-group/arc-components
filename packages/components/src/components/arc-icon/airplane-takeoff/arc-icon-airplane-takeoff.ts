...
import styles from './arc-icon-airplane-takeoff.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-airplane-takeoff')
export default class ArcIconAirplaneTakeoff extends LitElement {
  /** @internal */
  static tag = 'arc-icon-airplane-takeoff';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconAirplaneTakeoff.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-airplane-takeoff": ArcIconAirplaneTakeoff;
  }
}
