...
import styles from './arc-icon-airplane-tilt.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-airplane-tilt')
export default class ArcIconAirplaneTilt extends LitElement {
  /** @internal */
  static tag = 'arc-icon-airplane-tilt';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconAirplaneTilt.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-airplane-tilt": ArcIconAirplaneTilt;
  }
}
