...
import styles from './arc-icon-airplane.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-airplane')
export default class ArcIconAirplane extends LitElement {
  /** @internal */
  static tag = 'arc-icon-airplane';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconAirplane.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-airplane": ArcIconAirplane;
  }
}
