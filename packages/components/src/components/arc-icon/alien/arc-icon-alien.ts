...
import styles from './arc-icon-alien.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-alien')
export default class ArcIconAlien extends LitElement {
  /** @internal */
  static tag = 'arc-icon-alien';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconAlien.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
