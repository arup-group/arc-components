...
import './arc-icon-align-bottom-simple.js';

export default {
  title: 'Components/Icons/ArcIconAlignBottomSimple',
  component: 'arc-icon-align-bottom-simple',
  argTypes: {
    size: {
      control: 'select',
