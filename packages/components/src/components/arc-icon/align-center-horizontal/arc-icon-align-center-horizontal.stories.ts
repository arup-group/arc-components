...
import './arc-icon-align-center-horizontal.js';

export default {
  title: 'Components/Icons/ArcIconAlignCenterHorizontal',
  component: 'arc-icon-align-center-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-align-center-horizontal
