...
import './arc-icon-align-center-vertical-simple.js';

export default {
  title: 'Components/Icons/ArcIconAlignCenterVerticalSimple',
  component: 'arc-icon-align-center-vertical-simple',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-align-center-vertical-simple
