...
import './arc-icon-align-center-vertical.js';

export default {
  title: 'Components/Icons/ArcIconAlignCenterVertical',
  component: 'arc-icon-align-center-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-align-center-vertical
