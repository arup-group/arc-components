...
import styles from './arc-icon-app-window.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-app-window')
export default class ArcIconAppWindow extends LitElement {
  /** @internal */
  static tag = 'arc-icon-app-window';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconAppWindow.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-app-window': ArcIconAppWindow;
  }
}
