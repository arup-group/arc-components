...
import styles from './arc-icon-apple-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-apple-logo')
export default class ArcIconAppleLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-apple-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconAppleLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-apple-logo": ArcIconAppleLogo;
  }
}
