...
import styles from './arc-icon-archive-tray.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-archive-tray')
export default class ArcIconArchiveTray extends LitElement {
  /** @internal */
  static tag = 'arc-icon-archive-tray';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconArchiveTray.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-archive-tray': ArcIconArchiveTray;
  }
}
