...
import './arc-icon-arrow-bend-double-up-left.js';

export default {
  title: 'Components/Icons/ArcIconArrowBendDoubleUpLeft',
  component: 'arc-icon-arrow-bend-double-up-left',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-bend-double-up-left
