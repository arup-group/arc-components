...
import './arc-icon-arrow-bend-double-up-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowBendDoubleUpRight',
  component: 'arc-icon-arrow-bend-double-up-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-bend-double-up-right
