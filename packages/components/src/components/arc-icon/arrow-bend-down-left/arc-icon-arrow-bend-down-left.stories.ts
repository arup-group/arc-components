...
import './arc-icon-arrow-bend-down-left.js';

export default {
  title: 'Components/Icons/ArcIconArrowBendDownLeft',
  component: 'arc-icon-arrow-bend-down-left',
  argTypes: {
    size: {
      control: 'select',
