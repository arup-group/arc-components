...
import './arc-icon-arrow-bend-left-down.js';

export default {
  title: 'Components/Icons/ArcIconArrowBendLeftDown',
  component: 'arc-icon-arrow-bend-left-down',
  argTypes: {
    size: {
      control: 'select',
