...
import './arc-icon-arrow-bend-right-down.js';

export default {
  title: 'Components/Icons/ArcIconArrowBendRightDown',
  component: 'arc-icon-arrow-bend-right-down',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-bend-right-down
