...
import './arc-icon-arrow-bend-right-up.js';

export default {
  title: 'Components/Icons/ArcIconArrowBendRightUp',
  component: 'arc-icon-arrow-bend-right-up',
  argTypes: {
    size: {
      control: 'select',
