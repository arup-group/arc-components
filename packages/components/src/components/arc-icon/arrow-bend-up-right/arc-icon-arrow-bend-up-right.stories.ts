...
import './arc-icon-arrow-bend-up-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowBendUpRight',
  component: 'arc-icon-arrow-bend-up-right',
  argTypes: {
    size: {
      control: 'select',
