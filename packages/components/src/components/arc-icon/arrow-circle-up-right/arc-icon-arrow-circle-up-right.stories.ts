...
import './arc-icon-arrow-circle-up-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowCircleUpRight',
  component: 'arc-icon-arrow-circle-up-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-circle-up-right
