...
import './arc-icon-arrow-counter-clockwise.js';

export default {
  title: 'Components/Icons/ArcIconArrowCounterClockwise',
  component: 'arc-icon-arrow-counter-clockwise',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-counter-clockwise
