...
import './arc-icon-arrow-elbow-down-left.js';

export default {
  title: 'Components/Icons/ArcIconArrowElbowDownLeft',
  component: 'arc-icon-arrow-elbow-down-left',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-elbow-down-left
