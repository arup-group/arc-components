...
import './arc-icon-arrow-elbow-down-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowElbowDownRight',
  component: 'arc-icon-arrow-elbow-down-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-elbow-down-right
