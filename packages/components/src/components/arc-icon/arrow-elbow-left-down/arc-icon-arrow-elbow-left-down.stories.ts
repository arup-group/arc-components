...
import './arc-icon-arrow-elbow-left-down.js';

export default {
  title: 'Components/Icons/ArcIconArrowElbowLeftDown',
  component: 'arc-icon-arrow-elbow-left-down',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-elbow-left-down
