...
import './arc-icon-arrow-elbow-left-up.js';

export default {
  title: 'Components/Icons/ArcIconArrowElbowLeftUp',
  component: 'arc-icon-arrow-elbow-left-up',
  argTypes: {
    size: {
      control: 'select',
