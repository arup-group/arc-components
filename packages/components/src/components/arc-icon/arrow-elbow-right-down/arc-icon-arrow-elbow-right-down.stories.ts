...
import './arc-icon-arrow-elbow-right-down.js';

export default {
  title: 'Components/Icons/ArcIconArrowElbowRightDown',
  component: 'arc-icon-arrow-elbow-right-down',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-elbow-right-down
