...
import './arc-icon-arrow-elbow-up-left.js';

export default {
  title: 'Components/Icons/ArcIconArrowElbowUpLeft',
  component: 'arc-icon-arrow-elbow-up-left',
  argTypes: {
    size: {
      control: 'select',
