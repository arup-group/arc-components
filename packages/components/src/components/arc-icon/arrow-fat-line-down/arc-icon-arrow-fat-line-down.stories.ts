...
import './arc-icon-arrow-fat-line-down.js';

export default {
  title: 'Components/Icons/ArcIconArrowFatLineDown',
  component: 'arc-icon-arrow-fat-line-down',
  argTypes: {
    size: {
      control: 'select',
