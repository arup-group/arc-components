...
import './arc-icon-arrow-fat-line-left.js';

export default {
  title: 'Components/Icons/ArcIconArrowFatLineLeft',
  component: 'arc-icon-arrow-fat-line-left',
  argTypes: {
    size: {
      control: 'select',
