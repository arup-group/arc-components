...
import './arc-icon-arrow-fat-line-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowFatLineRight',
  component: 'arc-icon-arrow-fat-line-right',
  argTypes: {
    size: {
      control: 'select',
