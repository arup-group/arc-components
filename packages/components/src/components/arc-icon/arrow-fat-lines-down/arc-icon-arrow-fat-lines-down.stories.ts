...
import './arc-icon-arrow-fat-lines-down.js';

export default {
  title: 'Components/Icons/ArcIconArrowFatLinesDown',
  component: 'arc-icon-arrow-fat-lines-down',
  argTypes: {
    size: {
      control: 'select',
