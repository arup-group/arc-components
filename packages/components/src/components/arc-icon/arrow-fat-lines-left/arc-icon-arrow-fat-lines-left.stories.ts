...
import './arc-icon-arrow-fat-lines-left.js';

export default {
  title: 'Components/Icons/ArcIconArrowFatLinesLeft',
  component: 'arc-icon-arrow-fat-lines-left',
  argTypes: {
    size: {
      control: 'select',
