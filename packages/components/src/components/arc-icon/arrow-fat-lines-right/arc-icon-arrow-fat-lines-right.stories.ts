...
import './arc-icon-arrow-fat-lines-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowFatLinesRight',
  component: 'arc-icon-arrow-fat-lines-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-fat-lines-right
