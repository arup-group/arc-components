...
import './arc-icon-arrow-line-down-left.js';

export default {
  title: 'Components/Icons/ArcIconArrowLineDownLeft',
  component: 'arc-icon-arrow-line-down-left',
  argTypes: {
    size: {
      control: 'select',
