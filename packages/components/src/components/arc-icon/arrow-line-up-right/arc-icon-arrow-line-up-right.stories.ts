...
import './arc-icon-arrow-line-up-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowLineUpRight',
  component: 'arc-icon-arrow-line-up-right',
  argTypes: {
    size: {
      control: 'select',
