...
import './arc-icon-arrow-square-down-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowSquareDownRight',
  component: 'arc-icon-arrow-square-down-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-square-down-right
