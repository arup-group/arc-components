...
import './arc-icon-arrow-square-up-right.js';

export default {
  title: 'Components/Icons/ArcIconArrowSquareUpRight',
  component: 'arc-icon-arrow-square-up-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrow-square-up-right
