...
import styles from './arc-icon-arrows-clockwise.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-arrows-clockwise')
export default class ArcIconArrowsClockwise extends LitElement {
  /** @internal */
  static tag = 'arc-icon-arrows-clockwise';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconArrowsClockwise.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-arrows-clockwise": ArcIconArrowsClockwise;
  }
}
