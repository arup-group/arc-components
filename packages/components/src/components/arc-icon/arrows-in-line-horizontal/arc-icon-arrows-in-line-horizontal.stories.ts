...
import './arc-icon-arrows-in-line-horizontal.js';

export default {
  title: 'Components/Icons/ArcIconArrowsInLineHorizontal',
  component: 'arc-icon-arrows-in-line-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrows-in-line-horizontal
