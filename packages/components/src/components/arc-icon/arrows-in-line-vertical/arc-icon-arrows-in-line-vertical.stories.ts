...
import './arc-icon-arrows-in-line-vertical.js';

export default {
  title: 'Components/Icons/ArcIconArrowsInLineVertical',
  component: 'arc-icon-arrows-in-line-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-arrows-in-line-vertical
