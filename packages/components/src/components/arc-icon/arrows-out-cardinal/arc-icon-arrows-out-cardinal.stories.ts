...
import './arc-icon-arrows-out-cardinal.js';

export default {
  title: 'Components/Icons/ArcIconArrowsOutCardinal',
  component: 'arc-icon-arrows-out-cardinal',
  argTypes: {
    size: {
      control: 'select',
