...
import styles from './arc-icon-arrows-out-cardinal.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-arrows-out-cardinal')
export default class ArcIconArrowsOutCardinal extends LitElement {
  /** @internal */
  static tag = 'arc-icon-arrows-out-cardinal';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconArrowsOutCardinal.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-arrows-out-cardinal": ArcIconArrowsOutCardinal;
  }
}
