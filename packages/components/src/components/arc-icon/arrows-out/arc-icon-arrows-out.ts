...
import styles from './arc-icon-arrows-out.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-arrows-out')
export default class ArcIconArrowsOut extends LitElement {
  /** @internal */
  static tag = 'arc-icon-arrows-out';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconArrowsOut.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-arrows-out": ArcIconArrowsOut;
  }
}
