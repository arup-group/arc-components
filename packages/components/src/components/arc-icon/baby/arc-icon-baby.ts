...
import styles from './arc-icon-baby.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-baby')
export default class ArcIconBaby extends LitElement {
  /** @internal */
  static tag = 'arc-icon-baby';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBaby.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
