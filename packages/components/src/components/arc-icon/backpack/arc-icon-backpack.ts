...
import styles from './arc-icon-backpack.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-backpack')
export default class ArcIconBackpack extends LitElement {
  /** @internal */
  static tag = 'arc-icon-backpack';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBackpack.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-backpack": ArcIconBackpack;
  }
}
