...
import styles from './arc-icon-balloon.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-balloon')
export default class ArcIconBalloon extends LitElement {
  /** @internal */
  static tag = 'arc-icon-balloon';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBalloon.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-balloon": ArcIconBalloon;
  }
}
