...
import styles from './arc-icon-bandaids.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bandaids')
export default class ArcIconBandaids extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bandaids';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBandaids.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bandaids": ArcIconBandaids;
  }
}
