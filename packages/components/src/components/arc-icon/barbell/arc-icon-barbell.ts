...
import styles from './arc-icon-barbell.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-barbell')
export default class ArcIconBarbell extends LitElement {
  /** @internal */
  static tag = 'arc-icon-barbell';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBarbell.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-barbell": ArcIconBarbell;
  }
}
