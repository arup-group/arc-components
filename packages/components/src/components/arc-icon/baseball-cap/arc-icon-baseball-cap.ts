...
import styles from './arc-icon-baseball-cap.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-baseball-cap')
export default class ArcIconBaseballCap extends LitElement {
  /** @internal */
  static tag = 'arc-icon-baseball-cap';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBaseballCap.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-baseball-cap": ArcIconBaseballCap;
  }
}
