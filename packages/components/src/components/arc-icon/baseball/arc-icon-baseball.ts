...
import styles from './arc-icon-baseball.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-baseball')
export default class ArcIconBaseball extends LitElement {
  /** @internal */
  static tag = 'arc-icon-baseball';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBaseball.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-baseball": ArcIconBaseball;
  }
}
