...
import styles from './arc-icon-basketball.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-basketball')
export default class ArcIconBasketball extends LitElement {
  /** @internal */
  static tag = 'arc-icon-basketball';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBasketball.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-basketball": ArcIconBasketball;
  }
}
