...
import styles from './arc-icon-bathtub.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bathtub')
export default class ArcIconBathtub extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bathtub';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBathtub.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bathtub": ArcIconBathtub;
  }
}
