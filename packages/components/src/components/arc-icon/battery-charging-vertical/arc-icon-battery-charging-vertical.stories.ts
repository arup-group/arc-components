...
import './arc-icon-battery-charging-vertical.js';

export default {
  title: 'Components/Icons/ArcIconBatteryChargingVertical',
  component: 'arc-icon-battery-charging-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-battery-charging-vertical
