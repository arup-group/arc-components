...
import styles from './arc-icon-battery-charging-vertical.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-battery-charging-vertical')
export default class ArcIconBatteryChargingVertical extends LitElement {
  /** @internal */
  static tag = 'arc-icon-battery-charging-vertical';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBatteryChargingVertical.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-battery-charging-vertical": ArcIconBatteryChargingVertical;
  }
}
