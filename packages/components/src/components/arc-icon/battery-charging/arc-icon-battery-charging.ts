...
import styles from './arc-icon-battery-charging.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-battery-charging')
export default class ArcIconBatteryCharging extends LitElement {
  /** @internal */
  static tag = 'arc-icon-battery-charging';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBatteryCharging.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-battery-charging": ArcIconBatteryCharging;
  }
}
