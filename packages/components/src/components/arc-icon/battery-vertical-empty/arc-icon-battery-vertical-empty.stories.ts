...
import './arc-icon-battery-vertical-empty.js';

export default {
  title: 'Components/Icons/ArcIconBatteryVerticalEmpty',
  component: 'arc-icon-battery-vertical-empty',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-battery-vertical-empty
