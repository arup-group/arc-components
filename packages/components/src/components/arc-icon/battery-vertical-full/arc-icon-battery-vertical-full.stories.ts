...
import './arc-icon-battery-vertical-full.js';

export default {
  title: 'Components/Icons/ArcIconBatteryVerticalFull',
  component: 'arc-icon-battery-vertical-full',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-battery-vertical-full
