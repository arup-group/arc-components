...
import styles from './arc-icon-battery-vertical-full.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-battery-vertical-full')
export default class ArcIconBatteryVerticalFull extends LitElement {
  /** @internal */
  static tag = 'arc-icon-battery-vertical-full';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBatteryVerticalFull.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-battery-vertical-full": ArcIconBatteryVerticalFull;
  }
}
