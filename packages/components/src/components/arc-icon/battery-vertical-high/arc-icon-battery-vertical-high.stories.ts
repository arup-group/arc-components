...
import './arc-icon-battery-vertical-high.js';

export default {
  title: 'Components/Icons/ArcIconBatteryVerticalHigh',
  component: 'arc-icon-battery-vertical-high',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-battery-vertical-high
