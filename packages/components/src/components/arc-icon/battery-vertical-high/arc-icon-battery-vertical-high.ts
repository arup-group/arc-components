...
import styles from './arc-icon-battery-vertical-high.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-battery-vertical-high')
export default class ArcIconBatteryVerticalHigh extends LitElement {
  /** @internal */
  static tag = 'arc-icon-battery-vertical-high';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBatteryVerticalHigh.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-battery-vertical-high": ArcIconBatteryVerticalHigh;
  }
}
