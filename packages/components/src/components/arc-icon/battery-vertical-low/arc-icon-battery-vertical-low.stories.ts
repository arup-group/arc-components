...
import './arc-icon-battery-vertical-low.js';

export default {
  title: 'Components/Icons/ArcIconBatteryVerticalLow',
  component: 'arc-icon-battery-vertical-low',
  argTypes: {
    size: {
      control: 'select',
