...
import './arc-icon-battery-vertical-medium.js';

export default {
  title: 'Components/Icons/ArcIconBatteryVerticalMedium',
  component: 'arc-icon-battery-vertical-medium',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-battery-vertical-medium
