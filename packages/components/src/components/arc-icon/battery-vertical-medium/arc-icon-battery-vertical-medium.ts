...
import styles from './arc-icon-battery-vertical-medium.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-battery-vertical-medium')
export default class ArcIconBatteryVerticalMedium extends LitElement {
  /** @internal */
  static tag = 'arc-icon-battery-vertical-medium';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBatteryVerticalMedium.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-battery-vertical-medium": ArcIconBatteryVerticalMedium;
  }
}
