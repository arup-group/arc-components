...
import './arc-icon-battery-warning-vertical.js';

export default {
  title: 'Components/Icons/ArcIconBatteryWarningVertical',
  component: 'arc-icon-battery-warning-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-battery-warning-vertical
