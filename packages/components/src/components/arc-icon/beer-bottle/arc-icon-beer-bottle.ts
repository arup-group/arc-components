...
import styles from './arc-icon-beer-bottle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-beer-bottle')
export default class ArcIconBeerBottle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-beer-bottle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBeerBottle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-beer-bottle": ArcIconBeerBottle;
  }
}
