...
import styles from './arc-icon-beer-stein.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-beer-stein')
export default class ArcIconBeerStein extends LitElement {
  /** @internal */
  static tag = 'arc-icon-beer-stein';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBeerStein.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-beer-stein": ArcIconBeerStein;
  }
}
