...
import styles from './arc-icon-behance-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-behance-logo')
export default class ArcIconBehanceLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-behance-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBehanceLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-behance-logo": ArcIconBehanceLogo;
  }
}
