...
import styles from './arc-icon-bell-ringing.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bell-ringing')
export default class ArcIconBellRinging extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bell-ringing';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBellRinging.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bell-ringing": ArcIconBellRinging;
  }
}
