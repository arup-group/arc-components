...
import styles from './arc-icon-bell-simple-ringing.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bell-simple-ringing')
export default class ArcIconBellSimpleRinging extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bell-simple-ringing';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBellSimpleRinging.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bell-simple-ringing": ArcIconBellSimpleRinging;
  }
}
