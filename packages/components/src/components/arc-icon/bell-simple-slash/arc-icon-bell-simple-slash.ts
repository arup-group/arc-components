...
import styles from './arc-icon-bell-simple-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bell-simple-slash')
export default class ArcIconBellSimpleSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bell-simple-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBellSimpleSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bell-simple-slash": ArcIconBellSimpleSlash;
  }
}
