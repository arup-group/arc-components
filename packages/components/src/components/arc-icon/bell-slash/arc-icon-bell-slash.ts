...
import styles from './arc-icon-bell-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bell-slash')
export default class ArcIconBellSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bell-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBellSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bell-slash": ArcIconBellSlash;
  }
}
