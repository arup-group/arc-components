...
import styles from './arc-icon-bell-z.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bell-z')
export default class ArcIconBellZ extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bell-z';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBellZ.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
