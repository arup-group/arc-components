...
import styles from './arc-icon-bezier-curve.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bezier-curve')
export default class ArcIconBezierCurve extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bezier-curve';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBezierCurve.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bezier-curve": ArcIconBezierCurve;
  }
}
