...
import styles from './arc-icon-bicycle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bicycle')
export default class ArcIconBicycle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bicycle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBicycle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bicycle": ArcIconBicycle;
  }
}
