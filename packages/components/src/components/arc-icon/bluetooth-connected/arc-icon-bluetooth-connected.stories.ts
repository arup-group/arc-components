...
import './arc-icon-bluetooth-connected.js';

export default {
  title: 'Components/Icons/ArcIconBluetoothConnected',
  component: 'arc-icon-bluetooth-connected',
  argTypes: {
    size: {
      control: 'select',
