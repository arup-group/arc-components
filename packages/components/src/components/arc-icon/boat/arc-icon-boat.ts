...
import styles from './arc-icon-boat.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-boat')
export default class ArcIconBoat extends LitElement {
  /** @internal */
  static tag = 'arc-icon-boat';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBoat.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
