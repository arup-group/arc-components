...
import styles from './arc-icon-books.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-books')
export default class ArcIconBooks extends LitElement {
  /** @internal */
  static tag = 'arc-icon-books';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBooks.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
