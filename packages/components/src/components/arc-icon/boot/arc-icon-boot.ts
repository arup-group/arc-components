...
import styles from './arc-icon-boot.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-boot')
export default class ArcIconBoot extends LitElement {
  /** @internal */
  static tag = 'arc-icon-boot';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBoot.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
