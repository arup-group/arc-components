...
import styles from './arc-icon-bounding-box.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bounding-box')
export default class ArcIconBoundingBox extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bounding-box';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBoundingBox.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bounding-box": ArcIconBoundingBox;
  }
}
