...
import styles from './arc-icon-bowl-food.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bowl-food')
export default class ArcIconBowlFood extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bowl-food';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBowlFood.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bowl-food": ArcIconBowlFood;
  }
}
