...
import styles from './arc-icon-brackets-curly.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-brackets-curly')
export default class ArcIconBracketsCurly extends LitElement {
  /** @internal */
  static tag = 'arc-icon-brackets-curly';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBracketsCurly.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-brackets-curly": ArcIconBracketsCurly;
  }
}
