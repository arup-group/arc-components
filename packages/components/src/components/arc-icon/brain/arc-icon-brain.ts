...
import styles from './arc-icon-brain.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-brain')
export default class ArcIconBrain extends LitElement {
  /** @internal */
  static tag = 'arc-icon-brain';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBrain.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
