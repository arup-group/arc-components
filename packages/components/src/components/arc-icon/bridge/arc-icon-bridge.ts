...
import styles from './arc-icon-bridge.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bridge')
export default class ArcIconBridge extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bridge';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBridge.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
