...
import styles from './arc-icon-broom.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-broom')
export default class ArcIconBroom extends LitElement {
  /** @internal */
  static tag = 'arc-icon-broom';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBroom.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
