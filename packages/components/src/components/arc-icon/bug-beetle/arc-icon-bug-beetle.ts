...
import styles from './arc-icon-bug-beetle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bug-beetle')
export default class ArcIconBugBeetle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bug-beetle';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    [IconWeight.THIN, svg`<path d="M204,140h20a4,4,0,0,0,0-8H204V108h20a4,4,0,0,0,0-8H203.89a75.8,75.8,0,0,0-23.37-50.86l22.31-22.31a4,4,0,1,0-5.66-5.66L174.44,43.9a75.77,75.77,0,0,0-92.88,0L58.83,21.17a4,4,0,0,0-5.66,5.66L75.48,49.14A75.8,75.8,0,0,0,52.11,100H32a4,4,0,0,0,0,8H52v24H32a4,4,0,0,0,0,8H52v12a75.41,75.41,0,0,0,1,12H32a4,4,0,0,0,0,8H54.69a76,76,0,0,0,146.62,0H224a4,4,0,0,0,0-8H203a75.41,75.41,0,0,0,1-12ZM128,36a68.08,68.08,0,0,1,67.87,64H60.13A68.08,68.08,0,0,1,128,36Zm4,183.87V136a4,4,0,0,0-8,0v83.87A68.08,68.08,0,0,1,60,152V108H196v44A68.08,68.08,0,0,1,132,219.87Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBugBeetle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-bug-beetle": ArcIconBugBeetle;
  }
}
