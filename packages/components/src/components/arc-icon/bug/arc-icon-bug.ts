...
import styles from './arc-icon-bug.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bug')
export default class ArcIconBug extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bug';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBug.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
