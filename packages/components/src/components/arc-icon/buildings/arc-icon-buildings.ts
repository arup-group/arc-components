...
import styles from './arc-icon-buildings.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-buildings')
export default class ArcIconBuildings extends LitElement {
  /** @internal */
  static tag = 'arc-icon-buildings';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBuildings.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-buildings": ArcIconBuildings;
  }
}
