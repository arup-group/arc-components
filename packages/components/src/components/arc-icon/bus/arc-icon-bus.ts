...
import styles from './arc-icon-bus.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-bus')
export default class ArcIconBus extends LitElement {
  /** @internal */
  static tag = 'arc-icon-bus';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconBus.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
