...
import styles from './arc-icon-butterfly.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-butterfly')
export default class ArcIconButterfly extends LitElement {
  /** @internal */
  static tag = 'arc-icon-butterfly';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconButterfly.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-butterfly": ArcIconButterfly;
  }
}
