...
import styles from './arc-icon-cake.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cake')
export default class ArcIconCake extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cake';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCake.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
