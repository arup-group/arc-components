...
import styles from './arc-icon-camera-rotate.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-camera-rotate')
export default class ArcIconCameraRotate extends LitElement {
  /** @internal */
  static tag = 'arc-icon-camera-rotate';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCameraRotate.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-camera-rotate": ArcIconCameraRotate;
  }
}
