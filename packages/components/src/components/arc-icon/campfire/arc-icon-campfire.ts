...
import styles from './arc-icon-campfire.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-campfire')
export default class ArcIconCampfire extends LitElement {
  /** @internal */
  static tag = 'arc-icon-campfire';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCampfire.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-campfire": ArcIconCampfire;
  }
}
