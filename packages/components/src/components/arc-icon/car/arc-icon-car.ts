...
import styles from './arc-icon-car.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-car')
export default class ArcIconCar extends LitElement {
  /** @internal */
  static tag = 'arc-icon-car';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCar.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
