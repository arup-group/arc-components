...
import './arc-icon-caret-circle-double-down.js';

export default {
  title: 'Components/Icons/ArcIconCaretCircleDoubleDown',
  component: 'arc-icon-caret-circle-double-down',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-caret-circle-double-down
