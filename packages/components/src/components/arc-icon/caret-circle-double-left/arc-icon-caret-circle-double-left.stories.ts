...
import './arc-icon-caret-circle-double-left.js';

export default {
  title: 'Components/Icons/ArcIconCaretCircleDoubleLeft',
  component: 'arc-icon-caret-circle-double-left',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-caret-circle-double-left
