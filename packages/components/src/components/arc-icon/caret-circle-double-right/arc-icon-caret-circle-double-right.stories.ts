...
import './arc-icon-caret-circle-double-right.js';

export default {
  title: 'Components/Icons/ArcIconCaretCircleDoubleRight',
  component: 'arc-icon-caret-circle-double-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-caret-circle-double-right
