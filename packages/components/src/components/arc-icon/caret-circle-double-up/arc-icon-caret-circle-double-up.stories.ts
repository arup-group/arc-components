...
import './arc-icon-caret-circle-double-up.js';

export default {
  title: 'Components/Icons/ArcIconCaretCircleDoubleUp',
  component: 'arc-icon-caret-circle-double-up',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-caret-circle-double-up
