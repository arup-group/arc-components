...
import './arc-icon-caret-circle-up-down.js';

export default {
  title: 'Components/Icons/ArcIconCaretCircleUpDown',
  component: 'arc-icon-caret-circle-up-down',
  argTypes: {
    size: {
      control: 'select',
