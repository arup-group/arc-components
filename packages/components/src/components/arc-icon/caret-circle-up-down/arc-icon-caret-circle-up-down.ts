...
import styles from './arc-icon-caret-circle-up-down.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-caret-circle-up-down')
export default class ArcIconCaretCircleUpDown extends LitElement {
  /** @internal */
  static tag = 'arc-icon-caret-circle-up-down';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCaretCircleUpDown.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-caret-circle-up-down': ArcIconCaretCircleUpDown;
  }
}
