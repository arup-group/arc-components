...
import styles from './arc-icon-caret-double-left.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-caret-double-left')
export default class ArcIconCaretDoubleLeft extends LitElement {
  /** @internal */
  static tag = 'arc-icon-caret-double-left';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCaretDoubleLeft.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-caret-double-left': ArcIconCaretDoubleLeft;
  }
}
