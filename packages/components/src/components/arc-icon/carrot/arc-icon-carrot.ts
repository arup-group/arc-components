...
import styles from './arc-icon-carrot.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-carrot')
export default class ArcIconCarrot extends LitElement {
  /** @internal */
  static tag = 'arc-icon-carrot';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCarrot.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
