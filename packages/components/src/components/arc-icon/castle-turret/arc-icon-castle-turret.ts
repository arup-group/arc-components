...
import styles from './arc-icon-castle-turret.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-castle-turret')
export default class ArcIconCastleTurret extends LitElement {
  /** @internal */
  static tag = 'arc-icon-castle-turret';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M200,24h-8a16,16,0,0,0-16,16V56H148V40a16,16,0,0,0-16-16h-8a16,16,0,0,0-16,16V56H80V40A16,16,0,0,0,64,24H56A16,16,0,0,0,40,40V84.69A15.86,15.86,0,0,0,44.69,96L56,107.31V216a16,16,0,0,0,16,16H184a16,16,0,0,0,16-16V107.31L211.31,96A15.86,15.86,0,0,0,216,84.69V40A16,16,0,0,0,200,24ZM152,216H104V152a24,24,0,0,1,48,0Z"/>`],
    [IconWeight.DUOTONE, svg`<path d="M208,40V88l-16,16V216a8,8,0,0,1-8,8H152V152a24,24,0,0,0-48,0v72H72a8,8,0,0,1-8-8V104L48,88V40a8,8,0,0,1,8-8H72a8,8,0,0,1,8,8V56a8,8,0,0,0,8,8h16a8,8,0,0,0,8-8V40a8,8,0,0,1,8-8h16a8,8,0,0,1,8,8V56a8,8,0,0,0,8,8h16a8,8,0,0,0,8-8V40a8,8,0,0,1,8-8h16A8,8,0,0,1,208,40Z" opacity="0.2"/><path d="M200,24H184a16,16,0,0,0-16,16V56H152V40a16,16,0,0,0-16-16H120a16,16,0,0,0-16,16V56H88V40A16,16,0,0,0,72,24H56A16,16,0,0,0,40,40V84.69A15.86,15.86,0,0,0,44.69,96L56,107.31V216a16,16,0,0,0,16,16H184a16,16,0,0,0,16-16V107.31L211.31,96A15.86,15.86,0,0,0,216,84.69V40A16,16,0,0,0,200,24ZM144,216H112V152a16,16,0,0,1,32,0ZM200,84.69,188.69,96A15.86,15.86,0,0,0,184,107.31V216H160V152a32,32,0,0,0-64,0v64H72V107.31A15.86,15.86,0,0,0,67.31,96L56,84.69V40H72V56A16,16,0,0,0,88,72h16a16,16,0,0,0,16-16V40h16V56a16,16,0,0,0,16,16h16a16,16,0,0,0,16-16V40h16Z"/>`],
  ]);
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCastleTurret.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-castle-turret": ArcIconCastleTurret;
  }
}
