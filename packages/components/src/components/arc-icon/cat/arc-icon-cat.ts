...
import styles from './arc-icon-cat.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cat')
export default class ArcIconCat extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cat';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCat.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
