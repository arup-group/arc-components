...
import styles from './arc-icon-chalkboard-teacher.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-chalkboard-teacher')
export default class ArcIconChalkboardTeacher extends LitElement {
  /** @internal */
  static tag = 'arc-icon-chalkboard-teacher';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconChalkboardTeacher.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-chalkboard-teacher": ArcIconChalkboardTeacher;
  }
}
