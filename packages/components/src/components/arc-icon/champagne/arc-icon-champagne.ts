...
import styles from './arc-icon-champagne.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-champagne')
export default class ArcIconChampagne extends LitElement {
  /** @internal */
  static tag = 'arc-icon-champagne';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconChampagne.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-champagne": ArcIconChampagne;
  }
}
