...
import styles from './arc-icon-chart-donut.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-chart-donut')
export default class ArcIconChartDonut extends LitElement {
  /** @internal */
  static tag = 'arc-icon-chart-donut';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconChartDonut.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-chart-donut": ArcIconChartDonut;
  }
}
