...
import styles from './arc-icon-chart-line-down.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-chart-line-down')
export default class ArcIconChartLineDown extends LitElement {
  /** @internal */
  static tag = 'arc-icon-chart-line-down';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M232,208a8,8,0,0,1-8,8H32a8,8,0,0,1-8-8V48a8,8,0,0,1,16,0V60.69l56,56,26.34-26.35a8,8,0,0,1,11.32,0L180,136.69l14.34-14.35A8,8,0,0,1,208,128v40a8,8,0,0,1-8,8H160a8,8,0,0,1-5.66-13.66L168.69,148,128,107.31l-26.34,26.35a8,8,0,0,1-11.32,0L40,83.31V200H224A8,8,0,0,1,232,208Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconChartLineDown.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-chart-line-down": ArcIconChartLineDown;
  }
}
