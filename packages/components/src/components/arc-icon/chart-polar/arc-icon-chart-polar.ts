...
import styles from './arc-icon-chart-polar.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-chart-polar')
export default class ArcIconChartPolar extends LitElement {
  /** @internal */
  static tag = 'arc-icon-chart-polar';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconChartPolar.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-chart-polar": ArcIconChartPolar;
  }
}
