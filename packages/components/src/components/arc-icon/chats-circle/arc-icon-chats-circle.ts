...
import styles from './arc-icon-chats-circle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-chats-circle')
export default class ArcIconChatsCircle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-chats-circle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconChatsCircle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-chats-circle": ArcIconChatsCircle;
  }
}
