...
import './arc-icon-check-square-offset.js';

export default {
  title: 'Components/Icons/ArcIconCheckSquareOffset',
  component: 'arc-icon-check-square-offset',
  argTypes: {
    size: {
      control: 'select',
