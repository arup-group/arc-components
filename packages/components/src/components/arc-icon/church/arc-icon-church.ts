...
import styles from './arc-icon-church.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-church')
export default class ArcIconChurch extends LitElement {
  /** @internal */
  static tag = 'arc-icon-church';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconChurch.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
