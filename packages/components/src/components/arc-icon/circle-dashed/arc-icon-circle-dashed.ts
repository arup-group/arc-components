...
import styles from './arc-icon-circle-dashed.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-circle-dashed')
export default class ArcIconCircleDashed extends LitElement {
  /** @internal */
  static tag = 'arc-icon-circle-dashed';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCircleDashed.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-circle-dashed": ArcIconCircleDashed;
  }
}
