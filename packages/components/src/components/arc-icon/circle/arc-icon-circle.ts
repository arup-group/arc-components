...
import styles from './arc-icon-circle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-circle')
export default class ArcIconCircle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-circle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCircle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
