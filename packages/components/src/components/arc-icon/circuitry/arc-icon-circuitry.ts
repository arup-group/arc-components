...
import styles from './arc-icon-circuitry.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-circuitry')
export default class ArcIconCircuitry extends LitElement {
  /** @internal */
  static tag = 'arc-icon-circuitry';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.BOLD, svg`<path d="M208,28H48A20,20,0,0,0,28,48V208a20,20,0,0,0,20,20H208a20,20,0,0,0,20-20V48A20,20,0,0,0,208,28ZM52,52H76V152a20,20,0,1,0,24,0V125l40,40v39H52ZM204,204H164V160a12,12,0,0,0-3.51-8.49L100,91V52h24V72a12,12,0,0,0,3.51,8.49l20.71,20.7a20.17,20.17,0,1,0,17-17L148,67V52h56Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCircuitry.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-circuitry": ArcIconCircuitry;
  }
}
