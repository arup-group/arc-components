...
import styles from './arc-icon-clock-countdown.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-clock-countdown')
export default class ArcIconClockCountdown extends LitElement {
  /** @internal */
  static tag = 'arc-icon-clock-countdown';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconClockCountdown.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-clock-countdown': ArcIconClockCountdown;
  }
}
