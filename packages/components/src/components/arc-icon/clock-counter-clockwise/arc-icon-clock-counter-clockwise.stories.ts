...
import './arc-icon-clock-counter-clockwise.js';

export default {
  title: 'Components/Icons/ArcIconClockCounterClockwise',
  component: 'arc-icon-clock-counter-clockwise',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-clock-counter-clockwise
