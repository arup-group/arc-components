...
import styles from './arc-icon-cloud-arrow-down.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cloud-arrow-down')
export default class ArcIconCloudArrowDown extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cloud-arrow-down';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCloudArrowDown.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cloud-arrow-down": ArcIconCloudArrowDown;
  }
}
