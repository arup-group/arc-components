...
import styles from './arc-icon-cloud-arrow-up.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cloud-arrow-up')
export default class ArcIconCloudArrowUp extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cloud-arrow-up';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCloudArrowUp.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cloud-arrow-up": ArcIconCloudArrowUp;
  }
}
