...
import styles from './arc-icon-cloud-check.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cloud-check')
export default class ArcIconCloudCheck extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cloud-check';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCloudCheck.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cloud-check": ArcIconCloudCheck;
  }
}
