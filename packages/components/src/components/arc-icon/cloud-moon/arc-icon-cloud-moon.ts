...
import styles from './arc-icon-cloud-moon.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cloud-moon')
export default class ArcIconCloudMoon extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cloud-moon';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCloudMoon.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cloud-moon": ArcIconCloudMoon;
  }
}
