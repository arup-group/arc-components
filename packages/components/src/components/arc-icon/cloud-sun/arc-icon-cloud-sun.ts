...
import styles from './arc-icon-cloud-sun.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cloud-sun')
export default class ArcIconCloudSun extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cloud-sun';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCloudSun.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cloud-sun": ArcIconCloudSun;
  }
}
