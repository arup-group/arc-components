...
import styles from './arc-icon-cloud-x.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cloud-x')
export default class ArcIconCloudX extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cloud-x';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCloudX.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cloud-x": ArcIconCloudX;
  }
}
