...
import styles from './arc-icon-codepen-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-codepen-logo')
export default class ArcIconCodepenLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-codepen-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCodepenLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-codepen-logo": ArcIconCodepenLogo;
  }
}
