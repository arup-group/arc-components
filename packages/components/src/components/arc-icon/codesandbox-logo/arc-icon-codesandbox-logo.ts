...
import styles from './arc-icon-codesandbox-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-codesandbox-logo')
export default class ArcIconCodesandboxLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-codesandbox-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCodesandboxLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-codesandbox-logo": ArcIconCodesandboxLogo;
  }
}
