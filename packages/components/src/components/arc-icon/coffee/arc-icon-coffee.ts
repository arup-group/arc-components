...
import styles from './arc-icon-coffee.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-coffee')
export default class ArcIconCoffee extends LitElement {
  /** @internal */
  static tag = 'arc-icon-coffee';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCoffee.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
