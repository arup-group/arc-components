...
import styles from './arc-icon-coin.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-coin')
export default class ArcIconCoin extends LitElement {
  /** @internal */
  static tag = 'arc-icon-coin';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCoin.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
