...
import styles from './arc-icon-compass-tool.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-compass-tool')
export default class ArcIconCompassTool extends LitElement {
  /** @internal */
  static tag = 'arc-icon-compass-tool';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCompassTool.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-compass-tool": ArcIconCompassTool;
  }
}
