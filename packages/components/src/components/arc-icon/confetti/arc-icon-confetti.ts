...
import styles from './arc-icon-confetti.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-confetti')
export default class ArcIconConfetti extends LitElement {
  /** @internal */
  static tag = 'arc-icon-confetti';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconConfetti.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-confetti": ArcIconConfetti;
  }
}
