...
import './arc-icon-contactless-payment.js';

export default {
  title: 'Components/Icons/ArcIconContactlessPayment',
  component: 'arc-icon-contactless-payment',
  argTypes: {
    size: {
      control: 'select',
