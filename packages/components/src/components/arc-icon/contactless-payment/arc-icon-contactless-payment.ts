...
import styles from './arc-icon-contactless-payment.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-contactless-payment')
export default class ArcIconContactlessPayment extends LitElement {
  /** @internal */
  static tag = 'arc-icon-contactless-payment';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconContactlessPayment.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-contactless-payment": ArcIconContactlessPayment;
  }
}
