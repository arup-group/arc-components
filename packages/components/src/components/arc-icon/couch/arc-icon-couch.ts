...
import styles from './arc-icon-couch.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-couch')
export default class ArcIconCouch extends LitElement {
  /** @internal */
  static tag = 'arc-icon-couch';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCouch.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
