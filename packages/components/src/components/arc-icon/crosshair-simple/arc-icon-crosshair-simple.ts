...
import styles from './arc-icon-crosshair-simple.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-crosshair-simple')
export default class ArcIconCrosshairSimple extends LitElement {
  /** @internal */
  static tag = 'arc-icon-crosshair-simple';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCrosshairSimple.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-crosshair-simple': ArcIconCrosshairSimple;
  }
}
