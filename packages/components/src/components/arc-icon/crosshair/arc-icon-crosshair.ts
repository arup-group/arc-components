...
import styles from './arc-icon-crosshair.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-crosshair')
export default class ArcIconCrosshair extends LitElement {
  /** @internal */
  static tag = 'arc-icon-crosshair';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCrosshair.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-crosshair": ArcIconCrosshair;
  }
}
