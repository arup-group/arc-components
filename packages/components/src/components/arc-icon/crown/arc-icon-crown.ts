...
import styles from './arc-icon-crown.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-crown')
export default class ArcIconCrown extends LitElement {
  /** @internal */
  static tag = 'arc-icon-crown';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCrown.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
