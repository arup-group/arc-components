...
import styles from './arc-icon-cube-focus.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cube-focus')
export default class ArcIconCubeFocus extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cube-focus';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCubeFocus.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cube-focus": ArcIconCubeFocus;
  }
}
