...
import './arc-icon-currency-circle-dollar.js';

export default {
  title: 'Components/Icons/ArcIconCurrencyCircleDollar',
  component: 'arc-icon-currency-circle-dollar',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-currency-circle-dollar
