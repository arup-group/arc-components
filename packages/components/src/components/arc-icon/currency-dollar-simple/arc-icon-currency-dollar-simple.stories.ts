...
import './arc-icon-currency-dollar-simple.js';

export default {
  title: 'Components/Icons/ArcIconCurrencyDollarSimple',
  component: 'arc-icon-currency-dollar-simple',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-currency-dollar-simple
