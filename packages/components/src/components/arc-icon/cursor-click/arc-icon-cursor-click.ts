...
import styles from './arc-icon-cursor-click.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cursor-click')
export default class ArcIconCursorClick extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cursor-click';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCursorClick.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cursor-click": ArcIconCursorClick;
  }
}
