...
import styles from './arc-icon-cursor-text.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-cursor-text')
export default class ArcIconCursorText extends LitElement {
  /** @internal */
  static tag = 'arc-icon-cursor-text';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconCursorText.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-cursor-text": ArcIconCursorText;
  }
}
