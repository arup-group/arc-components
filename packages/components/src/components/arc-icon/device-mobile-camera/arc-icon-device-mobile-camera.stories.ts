...
import './arc-icon-device-mobile-camera.js';

export default {
  title: 'Components/Icons/ArcIconDeviceMobileCamera',
  component: 'arc-icon-device-mobile-camera',
  argTypes: {
    size: {
      control: 'select',
