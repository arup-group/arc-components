...
import './arc-icon-device-mobile-speaker.js';

export default {
  title: 'Components/Icons/ArcIconDeviceMobileSpeaker',
  component: 'arc-icon-device-mobile-speaker',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-device-mobile-speaker
