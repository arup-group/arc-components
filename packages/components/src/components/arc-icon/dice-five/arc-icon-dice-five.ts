...
import styles from './arc-icon-dice-five.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-dice-five')
export default class ArcIconDiceFive extends LitElement {
  /** @internal */
  static tag = 'arc-icon-dice-five';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDiceFive.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-dice-five": ArcIconDiceFive;
  }
}
