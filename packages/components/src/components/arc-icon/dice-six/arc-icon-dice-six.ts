...
import styles from './arc-icon-dice-six.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-dice-six')
export default class ArcIconDiceSix extends LitElement {
  /** @internal */
  static tag = 'arc-icon-dice-six';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDiceSix.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-dice-six": ArcIconDiceSix;
  }
}
