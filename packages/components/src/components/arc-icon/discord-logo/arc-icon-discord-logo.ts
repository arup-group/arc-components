...
import styles from './arc-icon-discord-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-discord-logo')
export default class ArcIconDiscordLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-discord-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDiscordLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-discord-logo': ArcIconDiscordLogo;
  }
}
