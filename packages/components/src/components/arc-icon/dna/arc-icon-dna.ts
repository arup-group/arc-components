...
import styles from './arc-icon-dna.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-dna')
export default class ArcIconDna extends LitElement {
  /** @internal */
  static tag = 'arc-icon-dna';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDna.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
