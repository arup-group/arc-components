...
import styles from './arc-icon-dog.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-dog')
export default class ArcIconDog extends LitElement {
  /** @internal */
  static tag = 'arc-icon-dog';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDog.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
