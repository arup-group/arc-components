...
import './arc-icon-dots-three-circle-vertical.js';

export default {
  title: 'Components/Icons/ArcIconDotsThreeCircleVertical',
  component: 'arc-icon-dots-three-circle-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-dots-three-circle-vertical
