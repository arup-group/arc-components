...
import styles from './arc-icon-dress.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-dress')
export default class ArcIconDress extends LitElement {
  /** @internal */
  static tag = 'arc-icon-dress';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDress.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
