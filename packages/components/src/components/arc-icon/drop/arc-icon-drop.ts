...
import styles from './arc-icon-drop.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-drop')
export default class ArcIconDrop extends LitElement {
  /** @internal */
  static tag = 'arc-icon-drop';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDrop.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
