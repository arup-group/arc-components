...
import styles from './arc-icon-dropbox-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-dropbox-logo')
export default class ArcIconDropboxLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-dropbox-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconDropboxLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-dropbox-logo": ArcIconDropboxLogo;
  }
}
