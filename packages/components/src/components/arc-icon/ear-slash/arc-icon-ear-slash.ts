...
import styles from './arc-icon-ear-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-ear-slash')
export default class ArcIconEarSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-ear-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEarSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-ear-slash": ArcIconEarSlash;
  }
}
