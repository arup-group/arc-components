...
import styles from './arc-icon-egg-crack.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-egg-crack')
export default class ArcIconEggCrack extends LitElement {
  /** @internal */
  static tag = 'arc-icon-egg-crack';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEggCrack.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-egg-crack": ArcIconEggCrack;
  }
}
