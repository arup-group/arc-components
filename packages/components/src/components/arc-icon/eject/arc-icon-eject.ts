...
import styles from './arc-icon-eject.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-eject')
export default class ArcIconEject extends LitElement {
  /** @internal */
  static tag = 'arc-icon-eject';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M224,176v24a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V176a16,16,0,0,1,16-16H208A16,16,0,0,1,224,176ZM48.24,144H207.76a16.18,16.18,0,0,0,14.93-9.76,15.59,15.59,0,0,0-3.1-17.12L145.86,39.61a24.76,24.76,0,0,0-35.72,0L36.41,117.12h0a15.59,15.59,0,0,0-3.1,17.12A16.18,16.18,0,0,0,48.24,144Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEject.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
