...
import styles from './arc-icon-engine.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-engine')
export default class ArcIconEngine extends LitElement {
  /** @internal */
  static tag = 'arc-icon-engine';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEngine.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
