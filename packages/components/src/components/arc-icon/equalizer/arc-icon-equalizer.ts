...
import styles from './arc-icon-equalizer.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-equalizer')
export default class ArcIconEqualizer extends LitElement {
  /** @internal */
  static tag = 'arc-icon-equalizer';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEqualizer.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-equalizer': ArcIconEqualizer;
  }
}
