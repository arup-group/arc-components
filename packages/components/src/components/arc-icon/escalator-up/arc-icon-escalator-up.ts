...
import styles from './arc-icon-escalator-up.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-escalator-up')
export default class ArcIconEscalatorUp extends LitElement {
  /** @internal */
  static tag = 'arc-icon-escalator-up';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEscalatorUp.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-escalator-up": ArcIconEscalatorUp;
  }
}
