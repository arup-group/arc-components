...
import styles from './arc-icon-exam.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-exam')
export default class ArcIconExam extends LitElement {
  /** @internal */
  static tag = 'arc-icon-exam';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconExam.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
