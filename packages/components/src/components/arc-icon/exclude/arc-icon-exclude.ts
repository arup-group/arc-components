...
import styles from './arc-icon-exclude.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-exclude')
export default class ArcIconExclude extends LitElement {
  /** @internal */
  static tag = 'arc-icon-exclude';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconExclude.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-exclude": ArcIconExclude;
  }
}
