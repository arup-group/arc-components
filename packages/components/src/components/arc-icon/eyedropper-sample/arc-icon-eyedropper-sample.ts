...
import styles from './arc-icon-eyedropper-sample.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-eyedropper-sample')
export default class ArcIconEyedropperSample extends LitElement {
  /** @internal */
  static tag = 'arc-icon-eyedropper-sample';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEyedropperSample.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-eyedropper-sample": ArcIconEyedropperSample;
  }
}
