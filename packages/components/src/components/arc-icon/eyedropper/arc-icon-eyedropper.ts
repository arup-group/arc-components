...
import styles from './arc-icon-eyedropper.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-eyedropper')
export default class ArcIconEyedropper extends LitElement {
  /** @internal */
  static tag = 'arc-icon-eyedropper';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconEyedropper.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-eyedropper": ArcIconEyedropper;
  }
}
