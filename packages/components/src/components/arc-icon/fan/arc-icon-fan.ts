...
import styles from './arc-icon-fan.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-fan')
export default class ArcIconFan extends LitElement {
  /** @internal */
  static tag = 'arc-icon-fan';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFan.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
