...
import styles from './arc-icon-fast-forward-circle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-fast-forward-circle')
export default class ArcIconFastForwardCircle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-fast-forward-circle';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm60.59,110.55-40,28A8,8,0,0,1,136,156V128a8,8,0,0,1-3.41,6.55l-40,28A8,8,0,0,1,80,156V100a8,8,0,0,1,12.59-6.55l40,28A8,8,0,0,1,136,128V100a8,8,0,0,1,12.59-6.55l40,28a8,8,0,0,1,0,13.1Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFastForwardCircle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-fast-forward-circle": ArcIconFastForwardCircle;
  }
}
