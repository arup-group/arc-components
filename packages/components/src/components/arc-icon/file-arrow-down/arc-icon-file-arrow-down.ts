...
import styles from './arc-icon-file-arrow-down.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-arrow-down')
export default class ArcIconFileArrowDown extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-arrow-down';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileArrowDown.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-arrow-down": ArcIconFileArrowDown;
  }
}
