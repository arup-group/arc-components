...
import styles from './arc-icon-file-audio.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-audio')
export default class ArcIconFileAudio extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-audio';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileAudio.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-audio": ArcIconFileAudio;
  }
}
