...
import styles from './arc-icon-file-cloud.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-cloud')
export default class ArcIconFileCloud extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-cloud';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileCloud.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-cloud": ArcIconFileCloud;
  }
}
