...
import styles from './arc-icon-file-code.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-code')
export default class ArcIconFileCode extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-code';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileCode.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-code": ArcIconFileCode;
  }
}
