...
import styles from './arc-icon-file-csv.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-csv')
export default class ArcIconFileCsv extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-csv';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileCsv.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-csv": ArcIconFileCsv;
  }
}
