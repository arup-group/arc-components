...
import styles from './arc-icon-file-doc.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-doc')
export default class ArcIconFileDoc extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-doc';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileDoc.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-doc": ArcIconFileDoc;
  }
}
