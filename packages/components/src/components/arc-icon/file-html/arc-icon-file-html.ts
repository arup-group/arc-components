...
import styles from './arc-icon-file-html.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-html')
export default class ArcIconFileHtml extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-html';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileHtml.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-html": ArcIconFileHtml;
  }
}
