...
import styles from './arc-icon-file-js.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-js')
export default class ArcIconFileJs extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-js';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileJs.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-js": ArcIconFileJs;
  }
}
