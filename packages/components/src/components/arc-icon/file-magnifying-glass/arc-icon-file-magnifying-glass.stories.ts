...
import './arc-icon-file-magnifying-glass.js';

export default {
  title: 'Components/Icons/ArcIconFileMagnifyingGlass',
  component: 'arc-icon-file-magnifying-glass',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-file-magnifying-glass
