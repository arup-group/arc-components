...
import styles from './arc-icon-file-pdf.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-pdf')
export default class ArcIconFilePdf extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-pdf';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFilePdf.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-pdf": ArcIconFilePdf;
  }
}
