...
import styles from './arc-icon-file-rs.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-rs')
export default class ArcIconFileRs extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-rs';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileRs.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-rs": ArcIconFileRs;
  }
}
