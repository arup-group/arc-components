...
import styles from './arc-icon-file-svg.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-svg')
export default class ArcIconFileSvg extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-svg';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileSvg.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-svg": ArcIconFileSvg;
  }
}
