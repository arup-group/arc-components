...
import styles from './arc-icon-file-ts.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-ts')
export default class ArcIconFileTs extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-ts';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileTs.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-ts": ArcIconFileTs;
  }
}
