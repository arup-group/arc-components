...
import styles from './arc-icon-file-tsx.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-tsx')
export default class ArcIconFileTsx extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-tsx';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileTsx.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-tsx": ArcIconFileTsx;
  }
}
