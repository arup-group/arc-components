...
import styles from './arc-icon-file-video.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-video')
export default class ArcIconFileVideo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-video';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileVideo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-video": ArcIconFileVideo;
  }
}
