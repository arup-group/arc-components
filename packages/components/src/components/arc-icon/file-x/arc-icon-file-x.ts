...
import styles from './arc-icon-file-x.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-x')
export default class ArcIconFileX extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-x';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileX.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
