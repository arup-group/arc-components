...
import styles from './arc-icon-file-xls.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-file-xls')
export default class ArcIconFileXls extends LitElement {
  /** @internal */
  static tag = 'arc-icon-file-xls';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFileXls.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-file-xls": ArcIconFileXls;
  }
}
