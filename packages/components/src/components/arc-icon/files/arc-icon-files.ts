...
import styles from './arc-icon-files.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-files')
export default class ArcIconFiles extends LitElement {
  /** @internal */
  static tag = 'arc-icon-files';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFiles.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
