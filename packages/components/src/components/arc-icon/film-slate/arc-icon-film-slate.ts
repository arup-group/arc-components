...
import styles from './arc-icon-film-slate.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-film-slate')
export default class ArcIconFilmSlate extends LitElement {
  /** @internal */
  static tag = 'arc-icon-film-slate';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFilmSlate.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-film-slate": ArcIconFilmSlate;
  }
}
