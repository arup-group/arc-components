...
import styles from './arc-icon-fingerprint-simple.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-fingerprint-simple')
export default class ArcIconFingerprintSimple extends LitElement {
  /** @internal */
  static tag = 'arc-icon-fingerprint-simple';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFingerprintSimple.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-fingerprint-simple": ArcIconFingerprintSimple;
  }
}
