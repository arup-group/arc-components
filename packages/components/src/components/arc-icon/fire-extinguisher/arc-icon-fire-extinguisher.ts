...
import styles from './arc-icon-fire-extinguisher.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-fire-extinguisher')
export default class ArcIconFireExtinguisher extends LitElement {
  /** @internal */
  static tag = 'arc-icon-fire-extinguisher';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFireExtinguisher.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-fire-extinguisher": ArcIconFireExtinguisher;
  }
}
