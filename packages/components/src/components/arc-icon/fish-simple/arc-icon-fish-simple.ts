...
import styles from './arc-icon-fish-simple.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-fish-simple')
export default class ArcIconFishSimple extends LitElement {
  /** @internal */
  static tag = 'arc-icon-fish-simple';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFishSimple.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-fish-simple": ArcIconFishSimple;
  }
}
