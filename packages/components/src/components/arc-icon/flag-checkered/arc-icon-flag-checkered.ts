...
import styles from './arc-icon-flag-checkered.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-flag-checkered')
export default class ArcIconFlagCheckered extends LitElement {
  /** @internal */
  static tag = 'arc-icon-flag-checkered';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFlagCheckered.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-flag-checkered": ArcIconFlagCheckered;
  }
}
