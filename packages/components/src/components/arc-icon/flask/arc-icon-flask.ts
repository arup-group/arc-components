...
import styles from './arc-icon-flask.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-flask')
export default class ArcIconFlask extends LitElement {
  /** @internal */
  static tag = 'arc-icon-flask';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFlask.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
