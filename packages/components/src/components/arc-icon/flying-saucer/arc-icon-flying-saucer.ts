...
import styles from './arc-icon-flying-saucer.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-flying-saucer')
export default class ArcIconFlyingSaucer extends LitElement {
  /** @internal */
  static tag = 'arc-icon-flying-saucer';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFlyingSaucer.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-flying-saucer': ArcIconFlyingSaucer;
  }
}
