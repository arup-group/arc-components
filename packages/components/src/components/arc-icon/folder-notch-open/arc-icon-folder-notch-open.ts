...
import styles from './arc-icon-folder-notch-open.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-folder-notch-open')
export default class ArcIconFolderNotchOpen extends LitElement {
  /** @internal */
  static tag = 'arc-icon-folder-notch-open';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFolderNotchOpen.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-folder-notch-open": ArcIconFolderNotchOpen;
  }
}
