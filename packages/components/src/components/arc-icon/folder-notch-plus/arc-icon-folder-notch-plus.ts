...
import styles from './arc-icon-folder-notch-plus.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-folder-notch-plus')
export default class ArcIconFolderNotchPlus extends LitElement {
  /** @internal */
  static tag = 'arc-icon-folder-notch-plus';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M216,72H130.66L102.92,51.2A16,16,0,0,0,93.34,48H40A16,16,0,0,0,24,64V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V88A16,16,0,0,0,216,72ZM40,96V64H93.34l21.33,16L93.33,96Zm112,64H136v16a8,8,0,0,1-16,0V160H104a8,8,0,0,1,0-16h16V128a8,8,0,0,1,16,0v16h16a8,8,0,0,1,0,16Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFolderNotchPlus.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-folder-notch-plus": ArcIconFolderNotchPlus;
  }
}
