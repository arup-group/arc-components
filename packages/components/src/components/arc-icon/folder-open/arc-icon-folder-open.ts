...
import styles from './arc-icon-folder-open.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-folder-open')
export default class ArcIconFolderOpen extends LitElement {
  /** @internal */
  static tag = 'arc-icon-folder-open';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFolderOpen.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-folder-open": ArcIconFolderOpen;
  }
}
