...
import './arc-icon-folder-simple-dashed.js';

export default {
  title: 'Components/Icons/ArcIconFolderSimpleDashed',
  component: 'arc-icon-folder-simple-dashed',
  argTypes: {
    size: {
      control: 'select',
