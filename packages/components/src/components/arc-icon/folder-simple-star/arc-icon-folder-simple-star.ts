...
import styles from './arc-icon-folder-simple-star.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-folder-simple-star')
export default class ArcIconFolderSimpleStar extends LitElement {
  /** @internal */
  static tag = 'arc-icon-folder-simple-star';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFolderSimpleStar.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-folder-simple-star": ArcIconFolderSimpleStar;
  }
}
