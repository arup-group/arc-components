...
import styles from './arc-icon-folder-star.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-folder-star')
export default class ArcIconFolderStar extends LitElement {
  /** @internal */
  static tag = 'arc-icon-folder-star';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFolderStar.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-folder-star": ArcIconFolderStar;
  }
}
