...
import styles from './arc-icon-folder-user.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-folder-user')
export default class ArcIconFolderUser extends LitElement {
  /** @internal */
  static tag = 'arc-icon-folder-user';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFolderUser.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-folder-user": ArcIconFolderUser;
  }
}
