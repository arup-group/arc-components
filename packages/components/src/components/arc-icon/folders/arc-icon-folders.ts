...
import styles from './arc-icon-folders.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-folders')
export default class ArcIconFolders extends LitElement {
  /** @internal */
  static tag = 'arc-icon-folders';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFolders.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-folders": ArcIconFolders;
  }
}
