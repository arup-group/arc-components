...
import styles from './arc-icon-football.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-football')
export default class ArcIconFootball extends LitElement {
  /** @internal */
  static tag = 'arc-icon-football';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFootball.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-football': ArcIconFootball;
  }
}
