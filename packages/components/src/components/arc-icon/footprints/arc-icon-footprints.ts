...
import styles from './arc-icon-footprints.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-footprints')
export default class ArcIconFootprints extends LitElement {
  /** @internal */
  static tag = 'arc-icon-footprints';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconFootprints.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-footprints": ArcIconFootprints;
  }
}
