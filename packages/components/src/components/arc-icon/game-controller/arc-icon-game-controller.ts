...
import styles from './arc-icon-game-controller.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-game-controller')
export default class ArcIconGameController extends LitElement {
  /** @internal */
  static tag = 'arc-icon-game-controller';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGameController.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-game-controller": ArcIconGameController;
  }
}
