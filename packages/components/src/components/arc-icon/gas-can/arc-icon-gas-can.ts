...
import styles from './arc-icon-gas-can.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-gas-can')
export default class ArcIconGasCan extends LitElement {
  /** @internal */
  static tag = 'arc-icon-gas-can';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGasCan.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-gas-can": ArcIconGasCan;
  }
}
