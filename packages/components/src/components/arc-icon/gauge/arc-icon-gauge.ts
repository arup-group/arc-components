...
import styles from './arc-icon-gauge.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-gauge')
export default class ArcIconGauge extends LitElement {
  /** @internal */
  static tag = 'arc-icon-gauge';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGauge.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
