...
import styles from './arc-icon-gavel.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-gavel')
export default class ArcIconGavel extends LitElement {
  /** @internal */
  static tag = 'arc-icon-gavel';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGavel.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
