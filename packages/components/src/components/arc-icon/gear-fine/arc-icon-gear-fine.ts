...
import styles from './arc-icon-gear-fine.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-gear-fine')
export default class ArcIconGearFine extends LitElement {
  /** @internal */
  static tag = 'arc-icon-gear-fine';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGearFine.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-gear-fine": ArcIconGearFine;
  }
}
