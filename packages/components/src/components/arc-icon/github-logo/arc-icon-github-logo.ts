...
import styles from './arc-icon-github-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-github-logo')
export default class ArcIconGithubLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-github-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGithubLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-github-logo": ArcIconGithubLogo;
  }
}
