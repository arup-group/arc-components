...
import styles from './arc-icon-gitlab-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-gitlab-logo')
export default class ArcIconGitlabLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-gitlab-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGitlabLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-gitlab-logo": ArcIconGitlabLogo;
  }
}
