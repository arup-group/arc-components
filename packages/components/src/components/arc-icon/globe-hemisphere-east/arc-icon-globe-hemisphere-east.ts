...
import styles from './arc-icon-globe-hemisphere-east.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-globe-hemisphere-east')
export default class ArcIconGlobeHemisphereEast extends LitElement {
  /** @internal */
  static tag = 'arc-icon-globe-hemisphere-east';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGlobeHemisphereEast.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-globe-hemisphere-east": ArcIconGlobeHemisphereEast;
  }
}
