...
import './arc-icon-globe-hemisphere-west.js';

export default {
  title: 'Components/Icons/ArcIconGlobeHemisphereWest',
  component: 'arc-icon-globe-hemisphere-west',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-globe-hemisphere-west
