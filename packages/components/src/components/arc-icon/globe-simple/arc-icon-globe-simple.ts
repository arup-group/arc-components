...
import styles from './arc-icon-globe-simple.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-globe-simple')
export default class ArcIconGlobeSimple extends LitElement {
  /** @internal */
  static tag = 'arc-icon-globe-simple';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGlobeSimple.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-globe-simple': ArcIconGlobeSimple;
  }
}
