...
import styles from './arc-icon-globe.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-globe')
export default class ArcIconGlobe extends LitElement {
  /** @internal */
  static tag = 'arc-icon-globe';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGlobe.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
