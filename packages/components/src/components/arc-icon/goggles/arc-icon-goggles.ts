...
import styles from './arc-icon-goggles.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-goggles')
export default class ArcIconGoggles extends LitElement {
  /** @internal */
  static tag = 'arc-icon-goggles';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGoggles.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-goggles": ArcIconGoggles;
  }
}
