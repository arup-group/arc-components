...
import styles from './arc-icon-google-cardboard-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-google-cardboard-logo')
export default class ArcIconGoogleCardboardLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-google-cardboard-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGoogleCardboardLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-google-cardboard-logo": ArcIconGoogleCardboardLogo;
  }
}
