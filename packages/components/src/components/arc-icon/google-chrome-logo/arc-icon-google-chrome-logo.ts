...
import styles from './arc-icon-google-chrome-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-google-chrome-logo')
export default class ArcIconGoogleChromeLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-google-chrome-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGoogleChromeLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-google-chrome-logo': ArcIconGoogleChromeLogo;
  }
}
