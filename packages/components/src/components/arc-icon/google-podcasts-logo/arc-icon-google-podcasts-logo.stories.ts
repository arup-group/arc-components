...
import './arc-icon-google-podcasts-logo.js';

export default {
  title: 'Components/Icons/ArcIconGooglePodcastsLogo',
  component: 'arc-icon-google-podcasts-logo',
  argTypes: {
    size: {
      control: 'select',
