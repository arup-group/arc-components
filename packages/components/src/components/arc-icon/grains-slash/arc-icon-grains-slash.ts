...
import styles from './arc-icon-grains-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-grains-slash')
export default class ArcIconGrainsSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-grains-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGrainsSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-grains-slash": ArcIconGrainsSlash;
  }
}
