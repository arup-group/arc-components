...
import styles from './arc-icon-grains.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-grains')
export default class ArcIconGrains extends LitElement {
  /** @internal */
  static tag = 'arc-icon-grains';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGrains.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
