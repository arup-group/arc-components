...
import styles from './arc-icon-graph.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-graph')
export default class ArcIconGraph extends LitElement {
  /** @internal */
  static tag = 'arc-icon-graph';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconGraph.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
