...
import styles from './arc-icon-hamburger.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hamburger')
export default class ArcIconHamburger extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hamburger';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHamburger.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hamburger": ArcIconHamburger;
  }
}
