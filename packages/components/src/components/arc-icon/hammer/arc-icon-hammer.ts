...
import styles from './arc-icon-hammer.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hammer')
export default class ArcIconHammer extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hammer';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHammer.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
