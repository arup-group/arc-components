...
import styles from './arc-icon-hand-eye.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hand-eye')
export default class ArcIconHandEye extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hand-eye';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandEye.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hand-eye": ArcIconHandEye;
  }
}
