...
import styles from './arc-icon-hand-fist.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hand-fist')
export default class ArcIconHandFist extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hand-fist';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandFist.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hand-fist": ArcIconHandFist;
  }
}
