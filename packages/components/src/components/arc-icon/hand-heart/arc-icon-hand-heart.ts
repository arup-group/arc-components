...
import styles from './arc-icon-hand-heart.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hand-heart')
export default class ArcIconHandHeart extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hand-heart';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandHeart.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hand-heart": ArcIconHandHeart;
  }
}
