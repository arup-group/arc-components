...
import styles from './arc-icon-hand-pointing.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hand-pointing')
export default class ArcIconHandPointing extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hand-pointing';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandPointing.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hand-pointing": ArcIconHandPointing;
  }
}
