...
import styles from './arc-icon-hand-swipe-left.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hand-swipe-left')
export default class ArcIconHandSwipeLeft extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hand-swipe-left';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandSwipeLeft.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hand-swipe-left": ArcIconHandSwipeLeft;
  }
}
