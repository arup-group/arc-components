...
import styles from './arc-icon-hand-waving.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hand-waving')
export default class ArcIconHandWaving extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hand-waving';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandWaving.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hand-waving": ArcIconHandWaving;
  }
}
