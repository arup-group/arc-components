...
import styles from './arc-icon-hand.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hand')
export default class ArcIconHand extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hand';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHand.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
