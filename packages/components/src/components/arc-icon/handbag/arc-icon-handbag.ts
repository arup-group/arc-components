...
import styles from './arc-icon-handbag.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-handbag')
export default class ArcIconHandbag extends LitElement {
  /** @internal */
  static tag = 'arc-icon-handbag';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandbag.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-handbag': ArcIconHandbag;
  }
}
