...
import styles from './arc-icon-hands-clapping.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hands-clapping')
export default class ArcIconHandsClapping extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hands-clapping';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandsClapping.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-hands-clapping': ArcIconHandsClapping;
  }
}
