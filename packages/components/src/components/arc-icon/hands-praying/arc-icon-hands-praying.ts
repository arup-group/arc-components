...
import styles from './arc-icon-hands-praying.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hands-praying')
export default class ArcIconHandsPraying extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hands-praying';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandsPraying.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hands-praying": ArcIconHandsPraying;
  }
}
