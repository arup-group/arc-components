...
import styles from './arc-icon-handshake.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-handshake')
export default class ArcIconHandshake extends LitElement {
  /** @internal */
  static tag = 'arc-icon-handshake';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHandshake.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-handshake": ArcIconHandshake;
  }
}
