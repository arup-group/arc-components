...
import styles from './arc-icon-headlights.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-headlights')
export default class ArcIconHeadlights extends LitElement {
  /** @internal */
  static tag = 'arc-icon-headlights';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHeadlights.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-headlights": ArcIconHeadlights;
  }
}
