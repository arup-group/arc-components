...
import styles from './arc-icon-heart-half.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-heart-half')
export default class ArcIconHeartHalf extends LitElement {
  /** @internal */
  static tag = 'arc-icon-heart-half';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHeartHalf.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-heart-half": ArcIconHeartHalf;
  }
}
