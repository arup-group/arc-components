...
import './arc-icon-heart-straight-break.js';

export default {
  title: 'Components/Icons/ArcIconHeartStraightBreak',
  component: 'arc-icon-heart-straight-break',
  argTypes: {
    size: {
      control: 'select',
