...
import styles from './arc-icon-heartbeat.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-heartbeat')
export default class ArcIconHeartbeat extends LitElement {
  /** @internal */
  static tag = 'arc-icon-heartbeat';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHeartbeat.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-heartbeat": ArcIconHeartbeat;
  }
}
