...
import styles from './arc-icon-hoodie.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hoodie')
export default class ArcIconHoodie extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hoodie';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHoodie.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
