...
import styles from './arc-icon-horse.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-horse')
export default class ArcIconHorse extends LitElement {
  /** @internal */
  static tag = 'arc-icon-horse';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHorse.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
