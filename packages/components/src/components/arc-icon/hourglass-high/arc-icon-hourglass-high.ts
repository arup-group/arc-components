...
import styles from './arc-icon-hourglass-high.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hourglass-high')
export default class ArcIconHourglassHigh extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hourglass-high';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHourglassHigh.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hourglass-high": ArcIconHourglassHigh;
  }
}
