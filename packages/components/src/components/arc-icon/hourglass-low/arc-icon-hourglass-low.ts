...
import styles from './arc-icon-hourglass-low.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hourglass-low')
export default class ArcIconHourglassLow extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hourglass-low';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHourglassLow.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hourglass-low": ArcIconHourglassLow;
  }
}
