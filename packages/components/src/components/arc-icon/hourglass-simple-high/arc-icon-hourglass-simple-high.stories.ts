...
import './arc-icon-hourglass-simple-high.js';

export default {
  title: 'Components/Icons/ArcIconHourglassSimpleHigh',
  component: 'arc-icon-hourglass-simple-high',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-hourglass-simple-high
