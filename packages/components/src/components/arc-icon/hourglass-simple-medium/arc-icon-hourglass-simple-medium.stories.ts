...
import './arc-icon-hourglass-simple-medium.js';

export default {
  title: 'Components/Icons/ArcIconHourglassSimpleMedium',
  component: 'arc-icon-hourglass-simple-medium',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-hourglass-simple-medium
