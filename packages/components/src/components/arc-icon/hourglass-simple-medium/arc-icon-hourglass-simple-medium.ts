...
import styles from './arc-icon-hourglass-simple-medium.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-hourglass-simple-medium')
export default class ArcIconHourglassSimpleMedium extends LitElement {
  /** @internal */
  static tag = 'arc-icon-hourglass-simple-medium';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconHourglassSimpleMedium.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-hourglass-simple-medium": ArcIconHourglassSimpleMedium;
  }
}
