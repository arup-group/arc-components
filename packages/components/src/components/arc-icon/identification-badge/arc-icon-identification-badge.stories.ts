...
import './arc-icon-identification-badge.js';

export default {
  title: 'Components/Icons/ArcIconIdentificationBadge',
  component: 'arc-icon-identification-badge',
  argTypes: {
    size: {
      control: 'select',
