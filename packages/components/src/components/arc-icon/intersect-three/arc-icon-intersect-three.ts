...
import styles from './arc-icon-intersect-three.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-intersect-three')
export default class ArcIconIntersectThree extends LitElement {
  /** @internal */
  static tag = 'arc-icon-intersect-three';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconIntersectThree.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-intersect-three": ArcIconIntersectThree;
  }
}
