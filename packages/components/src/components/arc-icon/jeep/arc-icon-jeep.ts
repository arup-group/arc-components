...
import styles from './arc-icon-jeep.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-jeep')
export default class ArcIconJeep extends LitElement {
  /** @internal */
  static tag = 'arc-icon-jeep';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconJeep.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
