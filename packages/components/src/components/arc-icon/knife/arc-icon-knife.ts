...
import styles from './arc-icon-knife.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-knife')
export default class ArcIconKnife extends LitElement {
  /** @internal */
  static tag = 'arc-icon-knife';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    [IconWeight.THIN, svg`<path d="M229,35a24,24,0,0,0-34,0L21.14,213.4a4,4,0,0,0,2,6.7,150.65,150.65,0,0,0,34,3.9c32.64,0,65.34-10.65,96.12-31.52,31.2-21.15,49.21-45,50-46a4,4,0,0,0-.37-5.24l-21.48-21.5L229,69A24.09,24.09,0,0,0,229,35ZM194.65,144.41a226.48,226.48,0,0,1-45.89,41.44C110.83,211.57,71.58,220.94,32,213.75L146.53,96.24Zm28.68-81.07a.76.76,0,0,0-.09.09L175.7,114.11l-23.58-23.6,48.57-49.83a16,16,0,0,1,22.64,22.66Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconKnife.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
