...
import styles from './arc-icon-ladder.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-ladder')
export default class ArcIconLadder extends LitElement {
  /** @internal */
  static tag = 'arc-icon-ladder';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLadder.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
