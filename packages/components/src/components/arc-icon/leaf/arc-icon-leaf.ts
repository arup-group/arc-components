...
import styles from './arc-icon-leaf.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-leaf')
export default class ArcIconLeaf extends LitElement {
  /** @internal */
  static tag = 'arc-icon-leaf';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLeaf.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
