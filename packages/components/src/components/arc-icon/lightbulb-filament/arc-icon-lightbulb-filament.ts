...
import styles from './arc-icon-lightbulb-filament.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-lightbulb-filament')
export default class ArcIconLightbulbFilament extends LitElement {
  /** @internal */
  static tag = 'arc-icon-lightbulb-filament';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLightbulbFilament.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-lightbulb-filament": ArcIconLightbulbFilament;
  }
}
