...
import styles from './arc-icon-lighthouse.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-lighthouse')
export default class ArcIconLighthouse extends LitElement {
  /** @internal */
  static tag = 'arc-icon-lighthouse';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLighthouse.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-lighthouse": ArcIconLighthouse;
  }
}
