...
import './arc-icon-link-simple-horizontal.js';

export default {
  title: 'Components/Icons/ArcIconLinkSimpleHorizontal',
  component: 'arc-icon-link-simple-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-link-simple-horizontal
