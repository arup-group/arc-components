...
import styles from './arc-icon-link.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-link')
export default class ArcIconLink extends LitElement {
  /** @internal */
  static tag = 'arc-icon-link';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLink.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
