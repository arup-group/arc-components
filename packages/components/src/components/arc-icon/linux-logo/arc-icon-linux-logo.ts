...
import styles from './arc-icon-linux-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-linux-logo')
export default class ArcIconLinuxLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-linux-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLinuxLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-linux-logo": ArcIconLinuxLogo;
  }
}
