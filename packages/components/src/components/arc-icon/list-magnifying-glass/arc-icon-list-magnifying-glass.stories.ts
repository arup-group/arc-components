...
import './arc-icon-list-magnifying-glass.js';

export default {
  title: 'Components/Icons/ArcIconListMagnifyingGlass',
  component: 'arc-icon-list-magnifying-glass',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-list-magnifying-glass
