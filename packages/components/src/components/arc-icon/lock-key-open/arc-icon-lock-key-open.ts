...
import styles from './arc-icon-lock-key-open.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-lock-key-open')
export default class ArcIconLockKeyOpen extends LitElement {
  /** @internal */
  static tag = 'arc-icon-lock-key-open';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLockKeyOpen.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-lock-key-open": ArcIconLockKeyOpen;
  }
}
