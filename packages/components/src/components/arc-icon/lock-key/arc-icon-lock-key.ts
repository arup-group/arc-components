...
import styles from './arc-icon-lock-key.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-lock-key')
export default class ArcIconLockKey extends LitElement {
  /** @internal */
  static tag = 'arc-icon-lock-key';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M208,80H176V56a48,48,0,0,0-96,0V80H48A16,16,0,0,0,32,96V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V96A16,16,0,0,0,208,80Zm-72,78.63V184a8,8,0,0,1-16,0V158.63a24,24,0,1,1,16,0ZM160,80H96V56a32,32,0,0,1,64,0Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLockKey.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-lock-key": ArcIconLockKey;
  }
}
