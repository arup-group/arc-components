...
import './arc-icon-lock-laminated-open.js';

export default {
  title: 'Components/Icons/ArcIconLockLaminatedOpen',
  component: 'arc-icon-lock-laminated-open',
  argTypes: {
    size: {
      control: 'select',
