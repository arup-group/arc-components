...
import styles from './arc-icon-lock-laminated-open.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-lock-laminated-open')
export default class ArcIconLockLaminatedOpen extends LitElement {
  /** @internal */
  static tag = 'arc-icon-lock-laminated-open';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconLockLaminatedOpen.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-lock-laminated-open": ArcIconLockLaminatedOpen;
  }
}
