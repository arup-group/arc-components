...
import styles from './arc-icon-magnet.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-magnet')
export default class ArcIconMagnet extends LitElement {
  /** @internal */
  static tag = 'arc-icon-magnet';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMagnet.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
