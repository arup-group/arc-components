...
import styles from './arc-icon-mask-happy.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-mask-happy')
export default class ArcIconMaskHappy extends LitElement {
  /** @internal */
  static tag = 'arc-icon-mask-happy';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMaskHappy.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-mask-happy": ArcIconMaskHappy;
  }
}
