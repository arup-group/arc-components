...
import styles from './arc-icon-mask-sad.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-mask-sad')
export default class ArcIconMaskSad extends LitElement {
  /** @internal */
  static tag = 'arc-icon-mask-sad';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMaskSad.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-mask-sad": ArcIconMaskSad;
  }
}
