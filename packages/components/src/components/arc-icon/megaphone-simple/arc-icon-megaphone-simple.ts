...
import styles from './arc-icon-megaphone-simple.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-megaphone-simple')
export default class ArcIconMegaphoneSimple extends LitElement {
  /** @internal */
  static tag = 'arc-icon-megaphone-simple';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMegaphoneSimple.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-megaphone-simple": ArcIconMegaphoneSimple;
  }
}
