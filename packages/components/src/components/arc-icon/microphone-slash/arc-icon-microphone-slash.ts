...
import styles from './arc-icon-microphone-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-microphone-slash')
export default class ArcIconMicrophoneSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-microphone-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMicrophoneSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-microphone-slash": ArcIconMicrophoneSlash;
  }
}
