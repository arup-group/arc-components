...
import './arc-icon-microsoft-excel-logo.js';

export default {
  title: 'Components/Icons/ArcIconMicrosoftExcelLogo',
  component: 'arc-icon-microsoft-excel-logo',
  argTypes: {
    size: {
      control: 'select',
