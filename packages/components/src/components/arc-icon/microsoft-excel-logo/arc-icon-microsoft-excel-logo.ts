...
import styles from './arc-icon-microsoft-excel-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-microsoft-excel-logo')
export default class ArcIconMicrosoftExcelLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-microsoft-excel-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMicrosoftExcelLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-microsoft-excel-logo': ArcIconMicrosoftExcelLogo;
  }
}
