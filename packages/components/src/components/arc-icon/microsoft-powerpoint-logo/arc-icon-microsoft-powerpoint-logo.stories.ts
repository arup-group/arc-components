...
import './arc-icon-microsoft-powerpoint-logo.js';

export default {
  title: 'Components/Icons/ArcIconMicrosoftPowerpointLogo',
  component: 'arc-icon-microsoft-powerpoint-logo',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-microsoft-powerpoint-logo
