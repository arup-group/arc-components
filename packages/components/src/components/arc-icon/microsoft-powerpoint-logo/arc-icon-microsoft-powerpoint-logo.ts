...
import styles from './arc-icon-microsoft-powerpoint-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-microsoft-powerpoint-logo')
export default class ArcIconMicrosoftPowerpointLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-microsoft-powerpoint-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMicrosoftPowerpointLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-microsoft-powerpoint-logo": ArcIconMicrosoftPowerpointLogo;
  }
}
