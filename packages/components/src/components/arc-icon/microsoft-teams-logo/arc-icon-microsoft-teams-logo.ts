...
import styles from './arc-icon-microsoft-teams-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-microsoft-teams-logo')
export default class ArcIconMicrosoftTeamsLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-microsoft-teams-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMicrosoftTeamsLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-microsoft-teams-logo": ArcIconMicrosoftTeamsLogo;
  }
}
