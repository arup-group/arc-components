...
import './arc-icon-microsoft-word-logo.js';

export default {
  title: 'Components/Icons/ArcIconMicrosoftWordLogo',
  component: 'arc-icon-microsoft-word-logo',
  argTypes: {
    size: {
      control: 'select',
