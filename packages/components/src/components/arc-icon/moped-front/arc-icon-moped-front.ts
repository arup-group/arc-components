...
import styles from './arc-icon-moped-front.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-moped-front')
export default class ArcIconMopedFront extends LitElement {
  /** @internal */
  static tag = 'arc-icon-moped-front';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMopedFront.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-moped-front": ArcIconMopedFront;
  }
}
