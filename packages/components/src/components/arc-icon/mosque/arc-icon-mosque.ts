...
import styles from './arc-icon-mosque.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-mosque')
export default class ArcIconMosque extends LitElement {
  /** @internal */
  static tag = 'arc-icon-mosque';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMosque.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
