...
import styles from './arc-icon-motorcycle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-motorcycle')
export default class ArcIconMotorcycle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-motorcycle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconMotorcycle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-motorcycle": ArcIconMotorcycle;
  }
}
