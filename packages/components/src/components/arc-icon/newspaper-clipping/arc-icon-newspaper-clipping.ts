...
import styles from './arc-icon-newspaper-clipping.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-newspaper-clipping')
export default class ArcIconNewspaperClipping extends LitElement {
  /** @internal */
  static tag = 'arc-icon-newspaper-clipping';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconNewspaperClipping.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-newspaper-clipping": ArcIconNewspaperClipping;
  }
}
