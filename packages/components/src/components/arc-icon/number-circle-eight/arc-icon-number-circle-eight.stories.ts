...
import './arc-icon-number-circle-eight.js';

export default {
  title: 'Components/Icons/ArcIconNumberCircleEight',
  component: 'arc-icon-number-circle-eight',
  argTypes: {
    size: {
      control: 'select',
