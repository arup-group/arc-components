...
import './arc-icon-number-circle-seven.js';

export default {
  title: 'Components/Icons/ArcIconNumberCircleSeven',
  component: 'arc-icon-number-circle-seven',
  argTypes: {
    size: {
      control: 'select',
