...
import './arc-icon-number-circle-three.js';

export default {
  title: 'Components/Icons/ArcIconNumberCircleThree',
  component: 'arc-icon-number-circle-three',
  argTypes: {
    size: {
      control: 'select',
