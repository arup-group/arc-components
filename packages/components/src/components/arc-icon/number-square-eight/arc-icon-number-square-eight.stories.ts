...
import './arc-icon-number-square-eight.js';

export default {
  title: 'Components/Icons/ArcIconNumberSquareEight',
  component: 'arc-icon-number-square-eight',
  argTypes: {
    size: {
      control: 'select',
