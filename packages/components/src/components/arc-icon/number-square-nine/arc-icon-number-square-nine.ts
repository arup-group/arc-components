...
import styles from './arc-icon-number-square-nine.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-number-square-nine')
export default class ArcIconNumberSquareNine extends LitElement {
  /** @internal */
  static tag = 'arc-icon-number-square-nine';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconNumberSquareNine.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-number-square-nine": ArcIconNumberSquareNine;
  }
}
