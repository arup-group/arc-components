...
import './arc-icon-number-square-seven.js';

export default {
  title: 'Components/Icons/ArcIconNumberSquareSeven',
  component: 'arc-icon-number-square-seven',
  argTypes: {
    size: {
      control: 'select',
