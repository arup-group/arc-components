...
import styles from './arc-icon-number-square-three.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-number-square-three')
export default class ArcIconNumberSquareThree extends LitElement {
  /** @internal */
  static tag = 'arc-icon-number-square-three';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconNumberSquareThree.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-number-square-three": ArcIconNumberSquareThree;
  }
}
