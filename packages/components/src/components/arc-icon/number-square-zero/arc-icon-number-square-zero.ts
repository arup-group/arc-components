...
import styles from './arc-icon-number-square-zero.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-number-square-zero')
export default class ArcIconNumberSquareZero extends LitElement {
  /** @internal */
  static tag = 'arc-icon-number-square-zero';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.BOLD, svg`<path d="M128,188c28.26,0,48-24.67,48-60s-19.74-60-48-60S80,92.67,80,128,99.74,188,128,188Zm0-96c23.33,0,24,32.32,24,36s-.67,36-24,36-24-32.32-24-36S104.67,92,128,92Zm80-64H48A20,20,0,0,0,28,48V208a20,20,0,0,0,20,20H208a20,20,0,0,0,20-20V48A20,20,0,0,0,208,28Zm-4,176H52V52H204Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconNumberSquareZero.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-number-square-zero": ArcIconNumberSquareZero;
  }
}
