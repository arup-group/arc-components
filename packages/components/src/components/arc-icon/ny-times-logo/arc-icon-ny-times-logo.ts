...
import styles from './arc-icon-ny-times-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-ny-times-logo')
export default class ArcIconNyTimesLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-ny-times-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconNyTimesLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-ny-times-logo": ArcIconNyTimesLogo;
  }
}
