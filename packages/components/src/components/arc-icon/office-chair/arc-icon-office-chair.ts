...
import styles from './arc-icon-office-chair.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-office-chair')
export default class ArcIconOfficeChair extends LitElement {
  /** @internal */
  static tag = 'arc-icon-office-chair';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconOfficeChair.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-office-chair": ArcIconOfficeChair;
  }
}
