...
import styles from './arc-icon-paint-brush-household.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-paint-brush-household')
export default class ArcIconPaintBrushHousehold extends LitElement {
  /** @internal */
  static tag = 'arc-icon-paint-brush-household';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPaintBrushHousehold.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-paint-brush-household": ArcIconPaintBrushHousehold;
  }
}
