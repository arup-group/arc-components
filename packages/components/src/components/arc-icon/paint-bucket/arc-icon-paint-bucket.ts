...
import styles from './arc-icon-paint-bucket.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-paint-bucket')
export default class ArcIconPaintBucket extends LitElement {
  /** @internal */
  static tag = 'arc-icon-paint-bucket';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPaintBucket.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-paint-bucket": ArcIconPaintBucket;
  }
}
