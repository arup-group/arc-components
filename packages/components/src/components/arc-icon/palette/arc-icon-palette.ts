...
import styles from './arc-icon-palette.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-palette')
export default class ArcIconPalette extends LitElement {
  /** @internal */
  static tag = 'arc-icon-palette';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPalette.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-palette": ArcIconPalette;
  }
}
