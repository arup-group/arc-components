...
import styles from './arc-icon-pants.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pants')
export default class ArcIconPants extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pants';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPants.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
