...
import styles from './arc-icon-paper-plane-tilt.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-paper-plane-tilt')
export default class ArcIconPaperPlaneTilt extends LitElement {
  /** @internal */
  static tag = 'arc-icon-paper-plane-tilt';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPaperPlaneTilt.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-paper-plane-tilt": ArcIconPaperPlaneTilt;
  }
}
