...
import './arc-icon-paperclip-horizontal.js';

export default {
  title: 'Components/Icons/ArcIconPaperclipHorizontal',
  component: 'arc-icon-paperclip-horizontal',
  argTypes: {
    size: {
      control: 'select',
