...
import styles from './arc-icon-paw-print.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-paw-print')
export default class ArcIconPawPrint extends LitElement {
  /** @internal */
  static tag = 'arc-icon-paw-print';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPawPrint.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-paw-print": ArcIconPawPrint;
  }
}
