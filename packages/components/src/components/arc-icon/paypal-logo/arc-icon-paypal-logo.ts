...
import styles from './arc-icon-paypal-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-paypal-logo')
export default class ArcIconPaypalLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-paypal-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPaypalLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-paypal-logo": ArcIconPaypalLogo;
  }
}
