...
import styles from './arc-icon-peace.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-peace')
export default class ArcIconPeace extends LitElement {
  /** @internal */
  static tag = 'arc-icon-peace';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPeace.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
