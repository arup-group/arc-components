...
import styles from './arc-icon-pen-nib-straight.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pen-nib-straight')
export default class ArcIconPenNibStraight extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pen-nib-straight';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPenNibStraight.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-pen-nib-straight": ArcIconPenNibStraight;
  }
}
