...
import styles from './arc-icon-pen-nib.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pen-nib')
export default class ArcIconPenNib extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pen-nib';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPenNib.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-pen-nib": ArcIconPenNib;
  }
}
