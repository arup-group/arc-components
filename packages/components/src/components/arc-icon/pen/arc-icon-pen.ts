...
import styles from './arc-icon-pen.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pen')
export default class ArcIconPen extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pen';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPen.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
