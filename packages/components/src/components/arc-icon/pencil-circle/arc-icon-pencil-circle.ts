...
import styles from './arc-icon-pencil-circle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pencil-circle')
export default class ArcIconPencilCircle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pencil-circle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPencilCircle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-pencil-circle": ArcIconPencilCircle;
  }
}
