...
import styles from './arc-icon-pencil-line.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pencil-line')
export default class ArcIconPencilLine extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pencil-line';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPencilLine.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-pencil-line": ArcIconPencilLine;
  }
}
