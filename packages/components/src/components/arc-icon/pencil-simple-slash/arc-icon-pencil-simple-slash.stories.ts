...
import './arc-icon-pencil-simple-slash.js';

export default {
  title: 'Components/Icons/ArcIconPencilSimpleSlash',
  component: 'arc-icon-pencil-simple-slash',
  argTypes: {
    size: {
      control: 'select',
