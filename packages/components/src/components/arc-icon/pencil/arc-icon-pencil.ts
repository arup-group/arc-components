...
import styles from './arc-icon-pencil.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pencil')
export default class ArcIconPencil extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pencil';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPencil.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
