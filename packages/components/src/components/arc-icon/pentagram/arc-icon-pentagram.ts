...
import styles from './arc-icon-pentagram.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pentagram')
export default class ArcIconPentagram extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pentagram';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPentagram.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-pentagram": ArcIconPentagram;
  }
}
