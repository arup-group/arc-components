...
import styles from './arc-icon-pepper.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pepper')
export default class ArcIconPepper extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pepper';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPepper.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
