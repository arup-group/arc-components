...
import styles from './arc-icon-person-arms-spread.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-person-arms-spread')
export default class ArcIconPersonArmsSpread extends LitElement {
  /** @internal */
  static tag = 'arc-icon-person-arms-spread';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPersonArmsSpread.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-person-arms-spread": ArcIconPersonArmsSpread;
  }
}
