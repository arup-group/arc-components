...
import styles from './arc-icon-person-simple-throw.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-person-simple-throw')
export default class ArcIconPersonSimpleThrow extends LitElement {
  /** @internal */
  static tag = 'arc-icon-person-simple-throw';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPersonSimpleThrow.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-person-simple-throw": ArcIconPersonSimpleThrow;
  }
}
