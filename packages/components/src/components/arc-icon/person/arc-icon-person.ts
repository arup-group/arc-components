...
import styles from './arc-icon-person.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-person')
export default class ArcIconPerson extends LitElement {
  /** @internal */
  static tag = 'arc-icon-person';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPerson.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
