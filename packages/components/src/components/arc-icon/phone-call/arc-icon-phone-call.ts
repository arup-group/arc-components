...
import styles from './arc-icon-phone-call.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-phone-call')
export default class ArcIconPhoneCall extends LitElement {
  /** @internal */
  static tag = 'arc-icon-phone-call';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPhoneCall.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-phone-call": ArcIconPhoneCall;
  }
}
