...
import styles from './arc-icon-phone-disconnect.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-phone-disconnect')
export default class ArcIconPhoneDisconnect extends LitElement {
  /** @internal */
  static tag = 'arc-icon-phone-disconnect';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPhoneDisconnect.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-phone-disconnect": ArcIconPhoneDisconnect;
  }
}
