...
import styles from './arc-icon-phone-plus.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-phone-plus')
export default class ArcIconPhonePlus extends LitElement {
  /** @internal */
  static tag = 'arc-icon-phone-plus';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPhonePlus.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-phone-plus": ArcIconPhonePlus;
  }
}
