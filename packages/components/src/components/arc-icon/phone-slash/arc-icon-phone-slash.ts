...
import styles from './arc-icon-phone-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-phone-slash')
export default class ArcIconPhoneSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-phone-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPhoneSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-phone-slash": ArcIconPhoneSlash;
  }
}
