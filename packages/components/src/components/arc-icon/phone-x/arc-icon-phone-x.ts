...
import styles from './arc-icon-phone-x.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-phone-x')
export default class ArcIconPhoneX extends LitElement {
  /** @internal */
  static tag = 'arc-icon-phone-x';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPhoneX.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-phone-x": ArcIconPhoneX;
  }
}
