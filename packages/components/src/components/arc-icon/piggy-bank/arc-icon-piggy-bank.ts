...
import styles from './arc-icon-piggy-bank.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-piggy-bank')
export default class ArcIconPiggyBank extends LitElement {
  /** @internal */
  static tag = 'arc-icon-piggy-bank';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPiggyBank.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-piggy-bank': ArcIconPiggyBank;
  }
}
