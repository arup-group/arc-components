...
import styles from './arc-icon-pinterest-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pinterest-logo')
export default class ArcIconPinterestLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pinterest-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPinterestLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-pinterest-logo": ArcIconPinterestLogo;
  }
}
