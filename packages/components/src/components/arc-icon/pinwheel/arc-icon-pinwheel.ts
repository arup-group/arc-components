...
import styles from './arc-icon-pinwheel.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-pinwheel')
export default class ArcIconPinwheel extends LitElement {
  /** @internal */
  static tag = 'arc-icon-pinwheel';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPinwheel.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-pinwheel": ArcIconPinwheel;
  }
}
