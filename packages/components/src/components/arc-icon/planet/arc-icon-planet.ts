...
import styles from './arc-icon-planet.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-planet')
export default class ArcIconPlanet extends LitElement {
  /** @internal */
  static tag = 'arc-icon-planet';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPlanet.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
