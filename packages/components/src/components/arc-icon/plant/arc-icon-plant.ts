...
import styles from './arc-icon-plant.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-plant')
export default class ArcIconPlant extends LitElement {
  /** @internal */
  static tag = 'arc-icon-plant';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPlant.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
