...
import styles from './arc-icon-plugs-connected.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-plugs-connected')
export default class ArcIconPlugsConnected extends LitElement {
  /** @internal */
  static tag = 'arc-icon-plugs-connected';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPlugsConnected.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-plugs-connected": ArcIconPlugsConnected;
  }
}
