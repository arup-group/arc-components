...
import styles from './arc-icon-plugs.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-plugs')
export default class ArcIconPlugs extends LitElement {
  /** @internal */
  static tag = 'arc-icon-plugs';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPlugs.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
