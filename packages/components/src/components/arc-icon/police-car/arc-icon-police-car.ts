...
import styles from './arc-icon-police-car.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-police-car')
export default class ArcIconPoliceCar extends LitElement {
  /** @internal */
  static tag = 'arc-icon-police-car';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPoliceCar.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-police-car": ArcIconPoliceCar;
  }
}
