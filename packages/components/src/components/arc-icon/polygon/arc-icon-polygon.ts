...
import styles from './arc-icon-polygon.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-polygon')
export default class ArcIconPolygon extends LitElement {
  /** @internal */
  static tag = 'arc-icon-polygon';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPolygon.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-polygon": ArcIconPolygon;
  }
}
