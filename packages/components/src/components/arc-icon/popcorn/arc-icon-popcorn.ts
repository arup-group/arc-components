...
import styles from './arc-icon-popcorn.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-popcorn')
export default class ArcIconPopcorn extends LitElement {
  /** @internal */
  static tag = 'arc-icon-popcorn';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPopcorn.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-popcorn": ArcIconPopcorn;
  }
}
