...
import styles from './arc-icon-potted-plant.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-potted-plant')
export default class ArcIconPottedPlant extends LitElement {
  /** @internal */
  static tag = 'arc-icon-potted-plant';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPottedPlant.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-potted-plant": ArcIconPottedPlant;
  }
}
