...
import './arc-icon-projector-screen-chart.js';

export default {
  title: 'Components/Icons/ArcIconProjectorScreenChart',
  component: 'arc-icon-projector-screen-chart',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-projector-screen-chart
