...
import './arc-icon-push-pin-simple-slash.js';

export default {
  title: 'Components/Icons/ArcIconPushPinSimpleSlash',
  component: 'arc-icon-push-pin-simple-slash',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-push-pin-simple-slash
