...
import styles from './arc-icon-push-pin-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-push-pin-slash')
export default class ArcIconPushPinSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-push-pin-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPushPinSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-push-pin-slash": ArcIconPushPinSlash;
  }
}
