...
import styles from './arc-icon-push-pin.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-push-pin')
export default class ArcIconPushPin extends LitElement {
  /** @internal */
  static tag = 'arc-icon-push-pin';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconPushPin.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-push-pin": ArcIconPushPin;
  }
}
