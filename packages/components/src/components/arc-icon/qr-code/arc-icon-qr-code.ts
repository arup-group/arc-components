...
import styles from './arc-icon-qr-code.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-qr-code')
export default class ArcIconQrCode extends LitElement {
  /** @internal */
  static tag = 'arc-icon-qr-code';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconQrCode.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-qr-code": ArcIconQrCode;
  }
}
