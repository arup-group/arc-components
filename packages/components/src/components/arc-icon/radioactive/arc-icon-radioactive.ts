...
import styles from './arc-icon-radioactive.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-radioactive')
export default class ArcIconRadioactive extends LitElement {
  /** @internal */
  static tag = 'arc-icon-radioactive';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconRadioactive.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-radioactive": ArcIconRadioactive;
  }
}
