...
import styles from './arc-icon-rainbow-cloud.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-rainbow-cloud')
export default class ArcIconRainbowCloud extends LitElement {
  /** @internal */
  static tag = 'arc-icon-rainbow-cloud';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconRainbowCloud.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-rainbow-cloud": ArcIconRainbowCloud;
  }
}
