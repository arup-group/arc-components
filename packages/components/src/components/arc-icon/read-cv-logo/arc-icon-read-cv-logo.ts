...
import styles from './arc-icon-read-cv-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-read-cv-logo')
export default class ArcIconReadCvLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-read-cv-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconReadCvLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-read-cv-logo": ArcIconReadCvLogo;
  }
}
