...
import styles from './arc-icon-record.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-record')
export default class ArcIconRecord extends LitElement {
  /** @internal */
  static tag = 'arc-icon-record';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconRecord.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
