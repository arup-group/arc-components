...
import styles from './arc-icon-rss.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-rss')
export default class ArcIconRss extends LitElement {
  /** @internal */
  static tag = 'arc-icon-rss';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconRss.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
