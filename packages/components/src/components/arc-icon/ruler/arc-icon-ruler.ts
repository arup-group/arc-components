...
import styles from './arc-icon-ruler.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-ruler')
export default class ArcIconRuler extends LitElement {
  /** @internal */
  static tag = 'arc-icon-ruler';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconRuler.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
