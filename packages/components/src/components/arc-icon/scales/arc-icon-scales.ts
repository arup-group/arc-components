...
import styles from './arc-icon-scales.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-scales')
export default class ArcIconScales extends LitElement {
  /** @internal */
  static tag = 'arc-icon-scales';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconScales.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
