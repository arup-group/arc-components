...
import styles from './arc-icon-scissors.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-scissors')
export default class ArcIconScissors extends LitElement {
  /** @internal */
  static tag = 'arc-icon-scissors';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconScissors.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-scissors": ArcIconScissors;
  }
}
