...
import styles from './arc-icon-scribble-loop.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-scribble-loop')
export default class ArcIconScribbleLoop extends LitElement {
  /** @internal */
  static tag = 'arc-icon-scribble-loop';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconScribbleLoop.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-scribble-loop": ArcIconScribbleLoop;
  }
}
