...
import styles from './arc-icon-selection-all.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-selection-all')
export default class ArcIconSelectionAll extends LitElement {
  /** @internal */
  static tag = 'arc-icon-selection-all';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSelectionAll.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-selection-all": ArcIconSelectionAll;
  }
}
