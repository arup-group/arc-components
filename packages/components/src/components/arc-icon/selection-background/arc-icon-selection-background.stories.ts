...
import './arc-icon-selection-background.js';

export default {
  title: 'Components/Icons/ArcIconSelectionBackground',
  component: 'arc-icon-selection-background',
  argTypes: {
    size: {
      control: 'select',
