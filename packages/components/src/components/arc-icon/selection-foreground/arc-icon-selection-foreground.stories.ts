...
import './arc-icon-selection-foreground.js';

export default {
  title: 'Components/Icons/ArcIconSelectionForeground',
  component: 'arc-icon-selection-foreground',
  argTypes: {
    size: {
      control: 'select',
