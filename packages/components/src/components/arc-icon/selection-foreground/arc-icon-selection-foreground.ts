...
import styles from './arc-icon-selection-foreground.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-selection-foreground')
export default class ArcIconSelectionForeground extends LitElement {
  /** @internal */
  static tag = 'arc-icon-selection-foreground';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSelectionForeground.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-selection-foreground": ArcIconSelectionForeground;
  }
}
