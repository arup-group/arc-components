...
import styles from './arc-icon-selection-inverse.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-selection-inverse')
export default class ArcIconSelectionInverse extends LitElement {
  /** @internal */
  static tag = 'arc-icon-selection-inverse';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSelectionInverse.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-selection-inverse": ArcIconSelectionInverse;
  }
}
