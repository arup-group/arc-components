...
import styles from './arc-icon-selection-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-selection-slash')
export default class ArcIconSelectionSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-selection-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSelectionSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-selection-slash": ArcIconSelectionSlash;
  }
}
