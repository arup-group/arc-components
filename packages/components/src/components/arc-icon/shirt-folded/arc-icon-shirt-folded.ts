...
import styles from './arc-icon-shirt-folded.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-shirt-folded')
export default class ArcIconShirtFolded extends LitElement {
  /** @internal */
  static tag = 'arc-icon-shirt-folded';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconShirtFolded.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-shirt-folded": ArcIconShirtFolded;
  }
}
