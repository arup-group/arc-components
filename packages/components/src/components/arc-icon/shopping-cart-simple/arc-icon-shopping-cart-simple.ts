...
import styles from './arc-icon-shopping-cart-simple.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-shopping-cart-simple')
export default class ArcIconShoppingCartSimple extends LitElement {
  /** @internal */
  static tag = 'arc-icon-shopping-cart-simple';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconShoppingCartSimple.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-shopping-cart-simple": ArcIconShoppingCartSimple;
  }
}
