...
import styles from './arc-icon-shrimp.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-shrimp')
export default class ArcIconShrimp extends LitElement {
  /** @internal */
  static tag = 'arc-icon-shrimp';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconShrimp.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
