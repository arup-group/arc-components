...
import styles from './arc-icon-shuffle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-shuffle')
export default class ArcIconShuffle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-shuffle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconShuffle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-shuffle": ArcIconShuffle;
  }
}
