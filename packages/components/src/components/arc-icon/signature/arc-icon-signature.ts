...
import styles from './arc-icon-signature.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-signature')
export default class ArcIconSignature extends LitElement {
  /** @internal */
  static tag = 'arc-icon-signature';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSignature.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-signature": ArcIconSignature;
  }
}
