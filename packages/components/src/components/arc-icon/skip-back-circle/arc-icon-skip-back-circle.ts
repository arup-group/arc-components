...
import styles from './arc-icon-skip-back-circle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-skip-back-circle')
export default class ArcIconSkipBackCircle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-skip-back-circle';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm40,144a8,8,0,0,1-12.65,6.51L104,137.83V168a8,8,0,0,1-16,0V88a8,8,0,0,1,16,0v30.17l51.35-36.68A8,8,0,0,1,168,88Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSkipBackCircle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-skip-back-circle": ArcIconSkipBackCircle;
  }
}
