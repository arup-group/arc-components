...
import './arc-icon-skip-forward-circle.js';

export default {
  title: 'Components/Icons/ArcIconSkipForwardCircle',
  component: 'arc-icon-skip-forward-circle',
  argTypes: {
    size: {
      control: 'select',
