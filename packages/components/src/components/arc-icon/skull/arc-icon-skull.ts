...
import styles from './arc-icon-skull.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-skull')
export default class ArcIconSkull extends LitElement {
  /** @internal */
  static tag = 'arc-icon-skull';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSkull.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
