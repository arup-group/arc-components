...
import styles from './arc-icon-slack-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-slack-logo')
export default class ArcIconSlackLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-slack-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSlackLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-slack-logo": ArcIconSlackLogo;
  }
}
