...
import styles from './arc-icon-smiley-sad.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-smiley-sad')
export default class ArcIconSmileySad extends LitElement {
  /** @internal */
  static tag = 'arc-icon-smiley-sad';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSmileySad.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-smiley-sad": ArcIconSmileySad;
  }
}
