...
import styles from './arc-icon-smiley-wink.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-smiley-wink')
export default class ArcIconSmileyWink extends LitElement {
  /** @internal */
  static tag = 'arc-icon-smiley-wink';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSmileyWink.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-smiley-wink": ArcIconSmileyWink;
  }
}
