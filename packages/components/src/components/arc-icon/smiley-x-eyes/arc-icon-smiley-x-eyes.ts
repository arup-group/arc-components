...
import styles from './arc-icon-smiley-x-eyes.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-smiley-x-eyes')
export default class ArcIconSmileyXEyes extends LitElement {
  /** @internal */
  static tag = 'arc-icon-smiley-x-eyes';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSmileyXEyes.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-smiley-x-eyes': ArcIconSmileyXEyes;
  }
}
