...
import styles from './arc-icon-sneaker-move.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-sneaker-move')
export default class ArcIconSneakerMove extends LitElement {
  /** @internal */
  static tag = 'arc-icon-sneaker-move';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSneakerMove.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-sneaker-move": ArcIconSneakerMove;
  }
}
