...
import styles from './arc-icon-sneaker.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-sneaker')
export default class ArcIconSneaker extends LitElement {
  /** @internal */
  static tag = 'arc-icon-sneaker';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSneaker.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-sneaker": ArcIconSneaker;
  }
}
