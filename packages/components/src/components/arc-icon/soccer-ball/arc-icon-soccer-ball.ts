...
import styles from './arc-icon-soccer-ball.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-soccer-ball')
export default class ArcIconSoccerBall extends LitElement {
  /** @internal */
  static tag = 'arc-icon-soccer-ball';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSoccerBall.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-soccer-ball": ArcIconSoccerBall;
  }
}
