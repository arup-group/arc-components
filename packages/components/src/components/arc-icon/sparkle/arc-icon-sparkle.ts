...
import styles from './arc-icon-sparkle.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-sparkle')
export default class ArcIconSparkle extends LitElement {
  /** @internal */
  static tag = 'arc-icon-sparkle';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSparkle.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-sparkle": ArcIconSparkle;
  }
}
