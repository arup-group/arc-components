...
import './arc-icon-speaker-simple-high.js';

export default {
  title: 'Components/Icons/ArcIconSpeakerSimpleHigh',
  component: 'arc-icon-speaker-simple-high',
  argTypes: {
    size: {
      control: 'select',
