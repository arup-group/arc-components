...
import styles from './arc-icon-speaker-simple-low.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-speaker-simple-low')
export default class ArcIconSpeakerSimpleLow extends LitElement {
  /** @internal */
  static tag = 'arc-icon-speaker-simple-low';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.FILL, svg`<path d="M160,32V224a8,8,0,0,1-12.91,6.31L77.25,176H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H77.25l69.84-54.31A8,8,0,0,1,160,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,192,96Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSpeakerSimpleLow.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-speaker-simple-low": ArcIconSpeakerSimpleLow;
  }
}
