...
import styles from './arc-icon-speaker-simple-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-speaker-simple-slash')
export default class ArcIconSpeakerSimpleSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-speaker-simple-slash';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    [IconWeight.THIN, svg`<path d="M188,152V104a4,4,0,0,1,8,0v48a4,4,0,0,1-8,0Zm36-68a4,4,0,0,0-4,4v80a4,4,0,0,0,8,0V88A4,4,0,0,0,224,84ZM211,213.31a4,4,0,1,1-5.92,5.38l-49-53.94V224a4,4,0,0,1-2.24,3.59A3.92,3.92,0,0,1,152,228a4.07,4.07,0,0,1-2.46-.84L78.63,172H32a12,12,0,0,1-12-12V96A12,12,0,0,1,32,84H82.59L45,42.69A4,4,0,0,1,51,37.31ZM148,156,89.87,92H32a4,4,0,0,0-4,4v64a4,4,0,0,0,4,4H80a4.06,4.06,0,0,1,2.46.84l65.54,51Zm-33.39-89.8,33.39-26v66.65a4,4,0,0,0,8,0V32a4,4,0,0,0-6.46-3.16l-39.85,31a4,4,0,1,0,4.92,6.31Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSpeakerSimpleSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-speaker-simple-slash": ArcIconSpeakerSimpleSlash;
  }
}
