...
import styles from './arc-icon-speaker-simple-x.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-speaker-simple-x')
export default class ArcIconSpeakerSimpleX extends LitElement {
  /** @internal */
  static tag = 'arc-icon-speaker-simple-x';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSpeakerSimpleX.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-speaker-simple-x": ArcIconSpeakerSimpleX;
  }
}
