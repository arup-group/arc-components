...
import styles from './arc-icon-spiral.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-spiral')
export default class ArcIconSpiral extends LitElement {
  /** @internal */
  static tag = 'arc-icon-spiral';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSpiral.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
