...
import styles from './arc-icon-spotify-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-spotify-logo')
export default class ArcIconSpotifyLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-spotify-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSpotifyLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-spotify-logo': ArcIconSpotifyLogo;
  }
}
