...
import './arc-icon-square-split-horizontal.js';

export default {
  title: 'Components/Icons/ArcIconSquareSplitHorizontal',
  component: 'arc-icon-square-split-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-square-split-horizontal
