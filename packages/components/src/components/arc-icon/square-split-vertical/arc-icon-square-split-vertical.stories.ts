...
import './arc-icon-square-split-vertical.js';

export default {
  title: 'Components/Icons/ArcIconSquareSplitVertical',
  component: 'arc-icon-square-split-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <arc-icon-square-split-vertical
