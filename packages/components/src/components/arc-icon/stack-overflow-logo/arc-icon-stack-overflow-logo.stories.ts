...
import './arc-icon-stack-overflow-logo.js';

export default {
  title: 'Components/Icons/ArcIconStackOverflowLogo',
  component: 'arc-icon-stack-overflow-logo',
  argTypes: {
    size: {
      control: 'select',
