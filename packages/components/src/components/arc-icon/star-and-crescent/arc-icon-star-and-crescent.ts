...
import styles from './arc-icon-star-and-crescent.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-star-and-crescent')
export default class ArcIconStarAndCrescent extends LitElement {
  /** @internal */
  static tag = 'arc-icon-star-and-crescent';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconStarAndCrescent.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-star-and-crescent": ArcIconStarAndCrescent;
  }
}
