...
import styles from './arc-icon-star-half.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-star-half')
export default class ArcIconStarHalf extends LitElement {
  /** @internal */
  static tag = 'arc-icon-star-half';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconStarHalf.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-star-half": ArcIconStarHalf;
  }
}
