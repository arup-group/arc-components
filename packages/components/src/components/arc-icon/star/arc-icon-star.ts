...
import styles from './arc-icon-star.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-star')
export default class ArcIconStar extends LitElement {
  /** @internal */
  static tag = 'arc-icon-star';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconStar.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
