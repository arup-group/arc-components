...
import styles from './arc-icon-steering-wheel.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-steering-wheel')
export default class ArcIconSteeringWheel extends LitElement {
  /** @internal */
  static tag = 'arc-icon-steering-wheel';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSteeringWheel.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-steering-wheel": ArcIconSteeringWheel;
  }
}
