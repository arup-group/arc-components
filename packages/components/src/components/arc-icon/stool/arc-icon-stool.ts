...
import styles from './arc-icon-stool.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-stool')
export default class ArcIconStool extends LitElement {
  /** @internal */
  static tag = 'arc-icon-stool';
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    ...
    [IconWeight.BOLD, svg`<path d="M204,64V40a20,20,0,0,0-20-20H72A20,20,0,0,0,52,40V64A20,20,0,0,0,72,84h2L52.15,222.13a12,12,0,1,0,23.7,3.74L83.1,180h89.8l7.25,45.87a12,12,0,1,0,23.7-3.74L182,84h2A20,20,0,0,0,204,64ZM76,44H180V60H76Zm93.11,112H86.89L98.25,84h59.5Z"/>`],
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconStool.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
