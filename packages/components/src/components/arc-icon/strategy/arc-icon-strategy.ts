...
import styles from './arc-icon-strategy.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-strategy')
export default class ArcIconStrategy extends LitElement {
  /** @internal */
  static tag = 'arc-icon-strategy';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconStrategy.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-strategy': ArcIconStrategy;
  }
}
