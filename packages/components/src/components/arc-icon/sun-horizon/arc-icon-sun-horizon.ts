...
import styles from './arc-icon-sun-horizon.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-sun-horizon')
export default class ArcIconSunHorizon extends LitElement {
  /** @internal */
  static tag = 'arc-icon-sun-horizon';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSunHorizon.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-sun-horizon": ArcIconSunHorizon;
  }
}
