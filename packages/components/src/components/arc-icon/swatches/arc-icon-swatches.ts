...
import styles from './arc-icon-swatches.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-swatches')
export default class ArcIconSwatches extends LitElement {
  /** @internal */
  static tag = 'arc-icon-swatches';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSwatches.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-swatches": ArcIconSwatches;
  }
}
