...
import styles from './arc-icon-swimming-pool.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-swimming-pool')
export default class ArcIconSwimmingPool extends LitElement {
  /** @internal */
  static tag = 'arc-icon-swimming-pool';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSwimmingPool.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-swimming-pool": ArcIconSwimmingPool;
  }
}
