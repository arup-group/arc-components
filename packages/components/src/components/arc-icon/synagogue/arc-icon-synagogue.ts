...
import styles from './arc-icon-synagogue.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-synagogue')
export default class ArcIconSynagogue extends LitElement {
  /** @internal */
  static tag = 'arc-icon-synagogue';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconSynagogue.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-synagogue": ArcIconSynagogue;
  }
}
