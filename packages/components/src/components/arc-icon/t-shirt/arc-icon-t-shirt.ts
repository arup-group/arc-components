...
import styles from './arc-icon-t-shirt.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-t-shirt')
export default class ArcIconTShirt extends LitElement {
  /** @internal */
  static tag = 'arc-icon-t-shirt';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTShirt.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-t-shirt": ArcIconTShirt;
  }
}
