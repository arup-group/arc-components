...
import styles from './arc-icon-tabs.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-tabs')
export default class ArcIconTabs extends LitElement {
  /** @internal */
  static tag = 'arc-icon-tabs';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTabs.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
