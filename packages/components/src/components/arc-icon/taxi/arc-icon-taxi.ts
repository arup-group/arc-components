...
import styles from './arc-icon-taxi.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-taxi')
export default class ArcIconTaxi extends LitElement {
  /** @internal */
  static tag = 'arc-icon-taxi';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTaxi.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
