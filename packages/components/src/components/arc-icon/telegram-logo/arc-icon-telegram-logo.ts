...
import styles from './arc-icon-telegram-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-telegram-logo')
export default class ArcIconTelegramLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-telegram-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTelegramLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-telegram-logo": ArcIconTelegramLogo;
  }
}
