...
import styles from './arc-icon-tennis-ball.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-tennis-ball')
export default class ArcIconTennisBall extends LitElement {
  /** @internal */
  static tag = 'arc-icon-tennis-ball';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTennisBall.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-tennis-ball": ArcIconTennisBall;
  }
}
