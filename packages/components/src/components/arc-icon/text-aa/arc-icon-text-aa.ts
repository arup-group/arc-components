...
import styles from './arc-icon-text-aa.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-text-aa')
export default class ArcIconTextAa extends LitElement {
  /** @internal */
  static tag = 'arc-icon-text-aa';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTextAa.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-text-aa": ArcIconTextAa;
  }
}
