...
import styles from './arc-icon-thermometer-cold.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-thermometer-cold')
export default class ArcIconThermometerCold extends LitElement {
  /** @internal */
  static tag = 'arc-icon-thermometer-cold';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconThermometerCold.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-thermometer-cold": ArcIconThermometerCold;
  }
}
