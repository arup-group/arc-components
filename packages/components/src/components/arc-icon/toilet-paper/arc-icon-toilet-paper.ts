...
import styles from './arc-icon-toilet-paper.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-toilet-paper')
export default class ArcIconToiletPaper extends LitElement {
  /** @internal */
  static tag = 'arc-icon-toilet-paper';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconToiletPaper.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-toilet-paper": ArcIconToiletPaper;
  }
}
