...
import styles from './arc-icon-toilet.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-toilet')
export default class ArcIconToilet extends LitElement {
  /** @internal */
  static tag = 'arc-icon-toilet';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconToilet.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
