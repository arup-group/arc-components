...
import styles from './arc-icon-toolbox.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-toolbox')
export default class ArcIconToolbox extends LitElement {
  /** @internal */
  static tag = 'arc-icon-toolbox';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconToolbox.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-toolbox": ArcIconToolbox;
  }
}
