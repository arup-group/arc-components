...
import styles from './arc-icon-tooth.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-tooth')
export default class ArcIconTooth extends LitElement {
  /** @internal */
  static tag = 'arc-icon-tooth';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTooth.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
