...
import styles from './arc-icon-tote.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-tote')
export default class ArcIconTote extends LitElement {
  /** @internal */
  static tag = 'arc-icon-tote';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTote.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
