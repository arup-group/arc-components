...
import styles from './arc-icon-traffic-sign.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-traffic-sign')
export default class ArcIconTrafficSign extends LitElement {
  /** @internal */
  static tag = 'arc-icon-traffic-sign';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTrafficSign.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-traffic-sign": ArcIconTrafficSign;
  }
}
