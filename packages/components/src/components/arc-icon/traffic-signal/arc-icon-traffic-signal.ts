...
import styles from './arc-icon-traffic-signal.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-traffic-signal')
export default class ArcIconTrafficSignal extends LitElement {
  /** @internal */
  static tag = 'arc-icon-traffic-signal';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTrafficSignal.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-traffic-signal": ArcIconTrafficSignal;
  }
}
