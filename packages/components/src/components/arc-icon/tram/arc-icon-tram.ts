...
import styles from './arc-icon-tram.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-tram')
export default class ArcIconTram extends LitElement {
  /** @internal */
  static tag = 'arc-icon-tram';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTram.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
