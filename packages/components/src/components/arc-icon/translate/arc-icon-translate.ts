...
import styles from './arc-icon-translate.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-translate')
export default class ArcIconTranslate extends LitElement {
  /** @internal */
  static tag = 'arc-icon-translate';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTranslate.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-translate": ArcIconTranslate;
  }
}
