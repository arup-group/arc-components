...
import styles from './arc-icon-trash-simple.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-trash-simple')
export default class ArcIconTrashSimple extends LitElement {
  /** @internal */
  static tag = 'arc-icon-trash-simple';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTrashSimple.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'arc-icon-trash-simple': ArcIconTrashSimple;
  }
}
