...
import styles from './arc-icon-tree-palm.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-tree-palm')
export default class ArcIconTreePalm extends LitElement {
  /** @internal */
  static tag = 'arc-icon-tree-palm';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTreePalm.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-tree-palm": ArcIconTreePalm;
  }
}
