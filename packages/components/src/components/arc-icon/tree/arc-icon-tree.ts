...
import styles from './arc-icon-tree.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-tree')
export default class ArcIconTree extends LitElement {
  /** @internal */
  static tag = 'arc-icon-tree';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTree.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
