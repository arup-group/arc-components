...
import styles from './arc-icon-trophy.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-trophy')
export default class ArcIconTrophy extends LitElement {
  /** @internal */
  static tag = 'arc-icon-trophy';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTrophy.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
