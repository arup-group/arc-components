...
import styles from './arc-icon-truck.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-truck')
export default class ArcIconTruck extends LitElement {
  /** @internal */
  static tag = 'arc-icon-truck';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconTruck.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
