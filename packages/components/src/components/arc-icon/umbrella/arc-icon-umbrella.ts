...
import styles from './arc-icon-umbrella.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-umbrella')
export default class ArcIconUmbrella extends LitElement {
  /** @internal */
  static tag = 'arc-icon-umbrella';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUmbrella.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-umbrella": ArcIconUmbrella;
  }
}
