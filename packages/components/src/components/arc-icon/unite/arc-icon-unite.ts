...
import styles from './arc-icon-unite.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-unite')
export default class ArcIconUnite extends LitElement {
  /** @internal */
  static tag = 'arc-icon-unite';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUnite.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
