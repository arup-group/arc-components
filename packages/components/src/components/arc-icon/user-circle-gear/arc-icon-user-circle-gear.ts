...
import styles from './arc-icon-user-circle-gear.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-user-circle-gear')
export default class ArcIconUserCircleGear extends LitElement {
  /** @internal */
  static tag = 'arc-icon-user-circle-gear';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUserCircleGear.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-user-circle-gear": ArcIconUserCircleGear;
  }
}
