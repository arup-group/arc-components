...
import styles from './arc-icon-user-focus.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-user-focus')
export default class ArcIconUserFocus extends LitElement {
  /** @internal */
  static tag = 'arc-icon-user-focus';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUserFocus.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-user-focus": ArcIconUserFocus;
  }
}
