...
import styles from './arc-icon-user-gear.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-user-gear')
export default class ArcIconUserGear extends LitElement {
  /** @internal */
  static tag = 'arc-icon-user-gear';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUserGear.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-user-gear": ArcIconUserGear;
  }
}
