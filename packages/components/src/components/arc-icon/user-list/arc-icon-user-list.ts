...
import styles from './arc-icon-user-list.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-user-list')
export default class ArcIconUserList extends LitElement {
  /** @internal */
  static tag = 'arc-icon-user-list';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUserList.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-user-list": ArcIconUserList;
  }
}
