...
import styles from './arc-icon-user-square.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-user-square')
export default class ArcIconUserSquare extends LitElement {
  /** @internal */
  static tag = 'arc-icon-user-square';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUserSquare.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-user-square": ArcIconUserSquare;
  }
}
