...
import styles from './arc-icon-users-four.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-users-four')
export default class ArcIconUsersFour extends LitElement {
  /** @internal */
  static tag = 'arc-icon-users-four';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconUsersFour.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-users-four": ArcIconUsersFour;
  }
}
