...
import styles from './arc-icon-video-camera-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-video-camera-slash')
export default class ArcIconVideoCameraSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-video-camera-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconVideoCameraSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-video-camera-slash": ArcIconVideoCameraSlash;
  }
}
