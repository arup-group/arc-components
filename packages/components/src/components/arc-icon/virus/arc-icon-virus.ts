...
import styles from './arc-icon-virus.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-virus')
export default class ArcIconVirus extends LitElement {
  /** @internal */
  static tag = 'arc-icon-virus';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconVirus.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
