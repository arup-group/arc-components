...
import styles from './arc-icon-volleyball.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-volleyball')
export default class ArcIconVolleyball extends LitElement {
  /** @internal */
  static tag = 'arc-icon-volleyball';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconVolleyball.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-volleyball": ArcIconVolleyball;
  }
}
