...
import styles from './arc-icon-warning-octagon.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-warning-octagon')
export default class ArcIconWarningOctagon extends LitElement {
  /** @internal */
  static tag = 'arc-icon-warning-octagon';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconWarningOctagon.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-warning-octagon": ArcIconWarningOctagon;
  }
}
