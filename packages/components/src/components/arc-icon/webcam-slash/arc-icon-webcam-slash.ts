...
import styles from './arc-icon-webcam-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-webcam-slash')
export default class ArcIconWebcamSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-webcam-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconWebcamSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-webcam-slash": ArcIconWebcamSlash;
  }
}
