...
import styles from './arc-icon-wheelchair.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-wheelchair')
export default class ArcIconWheelchair extends LitElement {
  /** @internal */
  static tag = 'arc-icon-wheelchair';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconWheelchair.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-wheelchair": ArcIconWheelchair;
  }
}
