...
export default class ArcIconWifiNone extends LitElement {
  ...
  static weightsMap = new Map<IconWeight, ReturnType<typeof svg>>([
    [
      IconWeight.THIN,
      svg`<path d="M136,204a8,8,0,1,1-8-8A8,8,0,0,1,136,204Z"/>`,
    ],
    [
      IconWeight.LIGHT,
      svg`<path d="M138,204a10,10,0,1,1-10-10A10,10,0,0,1,138,204Z"/>`,
    ],
    [
      IconWeight.REGULAR,
    ...
    [
      IconWeight.BOLD,
      svg`<path d="M144,204a16,16,0,1,1-16-16A16,16,0,0,1,144,204Z"/>`,
    ],
    [
      IconWeight.FILL,
