...
import styles from './arc-icon-wifi-slash.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-wifi-slash')
export default class ArcIconWifiSlash extends LitElement {
  /** @internal */
  static tag = 'arc-icon-wifi-slash';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconWifiSlash.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-wifi-slash": ArcIconWifiSlash;
  }
}
