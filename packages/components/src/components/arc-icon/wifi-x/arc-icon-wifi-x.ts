...
import styles from './arc-icon-wifi-x.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-wifi-x')
export default class ArcIconWifiX extends LitElement {
  /** @internal */
  static tag = 'arc-icon-wifi-x';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconWifiX.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
