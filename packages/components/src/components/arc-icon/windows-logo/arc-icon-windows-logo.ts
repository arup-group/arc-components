...
import styles from './arc-icon-windows-logo.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-windows-logo')
export default class ArcIconWindowsLogo extends LitElement {
  /** @internal */
  static tag = 'arc-icon-windows-logo';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconWindowsLogo.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    "arc-icon-windows-logo": ArcIconWindowsLogo;
  }
}
