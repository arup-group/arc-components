...
import styles from './arc-icon-wine.styles.js';

/**
 * @cssproperty --icon-color-primary - Set the primary color of the icon.
 * @cssproperty --icon-color-secondary - Set the secondary color of the icon (if supported).
 */
@customElement('arc-icon-wine')
export default class ArcIconWine extends LitElement {
  /** @internal */
  static tag = 'arc-icon-wine';
  ...
  protected render() {
    return html`
      ...
      >
        ${ArcIconWine.weightsMap.get(this.weight)}
      </svg>
    `;
  }
}
