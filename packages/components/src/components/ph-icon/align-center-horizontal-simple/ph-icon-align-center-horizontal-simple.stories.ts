...
import './ph-icon-align-center-horizontal-simple.js';

export default {
  title: 'Components/Icons/PhIconAlignCenterHorizontalSimple',
  component: 'ph-icon-align-center-horizontal-simple',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-align-center-horizontal-simple
