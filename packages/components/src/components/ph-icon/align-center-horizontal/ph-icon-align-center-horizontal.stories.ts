...
import './ph-icon-align-center-horizontal.js';

export default {
  title: 'Components/Icons/PhIconAlignCenterHorizontal',
  component: 'ph-icon-align-center-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-align-center-horizontal
