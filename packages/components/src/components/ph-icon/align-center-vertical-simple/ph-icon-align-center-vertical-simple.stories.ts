...
import './ph-icon-align-center-vertical-simple.js';

export default {
  title: 'Components/Icons/PhIconAlignCenterVerticalSimple',
  component: 'ph-icon-align-center-vertical-simple',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-align-center-vertical-simple
