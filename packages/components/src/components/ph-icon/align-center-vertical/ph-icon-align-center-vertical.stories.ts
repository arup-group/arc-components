...
import './ph-icon-align-center-vertical.js';

export default {
  title: 'Components/Icons/PhIconAlignCenterVertical',
  component: 'ph-icon-align-center-vertical',
  argTypes: {
    size: {
      control: 'select',
