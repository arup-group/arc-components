...
import './ph-icon-arrow-bend-double-up-left.js';

export default {
  title: 'Components/Icons/PhIconArrowBendDoubleUpLeft',
  component: 'ph-icon-arrow-bend-double-up-left',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-bend-double-up-left
