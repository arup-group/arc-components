...
import './ph-icon-arrow-bend-double-up-right.js';

export default {
  title: 'Components/Icons/PhIconArrowBendDoubleUpRight',
  component: 'ph-icon-arrow-bend-double-up-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-bend-double-up-right
