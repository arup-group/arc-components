...
import './ph-icon-arrow-bend-down-right.js';

export default {
  title: 'Components/Icons/PhIconArrowBendDownRight',
  component: 'ph-icon-arrow-bend-down-right',
  argTypes: {
    size: {
      control: 'select',
