...
import './ph-icon-arrow-bend-left-down.js';

export default {
  title: 'Components/Icons/PhIconArrowBendLeftDown',
  component: 'ph-icon-arrow-bend-left-down',
  argTypes: {
    size: {
      control: 'select',
