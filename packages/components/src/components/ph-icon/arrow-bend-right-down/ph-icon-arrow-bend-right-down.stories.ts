...
import './ph-icon-arrow-bend-right-down.js';

export default {
  title: 'Components/Icons/PhIconArrowBendRightDown',
  component: 'ph-icon-arrow-bend-right-down',
  argTypes: {
    size: {
      control: 'select',
