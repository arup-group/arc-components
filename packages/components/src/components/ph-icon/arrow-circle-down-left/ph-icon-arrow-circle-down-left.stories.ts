...
import './ph-icon-arrow-circle-down-left.js';

export default {
  title: 'Components/Icons/PhIconArrowCircleDownLeft',
  component: 'ph-icon-arrow-circle-down-left',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-circle-down-left
