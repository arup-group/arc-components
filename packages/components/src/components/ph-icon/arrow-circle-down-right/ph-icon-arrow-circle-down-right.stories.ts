...
import './ph-icon-arrow-circle-down-right.js';

export default {
  title: 'Components/Icons/PhIconArrowCircleDownRight',
  component: 'ph-icon-arrow-circle-down-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-circle-down-right
