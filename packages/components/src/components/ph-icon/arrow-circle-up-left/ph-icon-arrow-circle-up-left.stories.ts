...
import './ph-icon-arrow-circle-up-left.js';

export default {
  title: 'Components/Icons/PhIconArrowCircleUpLeft',
  component: 'ph-icon-arrow-circle-up-left',
  argTypes: {
    size: {
      control: 'select',
