...
import './ph-icon-arrow-circle-up-right.js';

export default {
  title: 'Components/Icons/PhIconArrowCircleUpRight',
  component: 'ph-icon-arrow-circle-up-right',
  argTypes: {
    size: {
      control: 'select',
