...
import './ph-icon-arrow-counter-clockwise.js';

export default {
  title: 'Components/Icons/PhIconArrowCounterClockwise',
  component: 'ph-icon-arrow-counter-clockwise',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-counter-clockwise
