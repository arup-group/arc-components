...
import './ph-icon-arrow-elbow-down-left.js';

export default {
  title: 'Components/Icons/PhIconArrowElbowDownLeft',
  component: 'ph-icon-arrow-elbow-down-left',
  argTypes: {
    size: {
      control: 'select',
