...
import './ph-icon-arrow-elbow-down-right.js';

export default {
  title: 'Components/Icons/PhIconArrowElbowDownRight',
  component: 'ph-icon-arrow-elbow-down-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-elbow-down-right
