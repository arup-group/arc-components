...
import './ph-icon-arrow-elbow-left-down.js';

export default {
  title: 'Components/Icons/PhIconArrowElbowLeftDown',
  component: 'ph-icon-arrow-elbow-left-down',
  argTypes: {
    size: {
      control: 'select',
