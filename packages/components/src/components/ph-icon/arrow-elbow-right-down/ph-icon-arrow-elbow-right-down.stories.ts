...
import './ph-icon-arrow-elbow-right-down.js';

export default {
  title: 'Components/Icons/PhIconArrowElbowRightDown',
  component: 'ph-icon-arrow-elbow-right-down',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-elbow-right-down
