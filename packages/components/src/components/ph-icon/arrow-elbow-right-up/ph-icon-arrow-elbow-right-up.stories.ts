...
import './ph-icon-arrow-elbow-right-up.js';

export default {
  title: 'Components/Icons/PhIconArrowElbowRightUp',
  component: 'ph-icon-arrow-elbow-right-up',
  argTypes: {
    size: {
      control: 'select',
