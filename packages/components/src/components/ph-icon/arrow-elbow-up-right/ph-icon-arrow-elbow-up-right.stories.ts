...
import './ph-icon-arrow-elbow-up-right.js';

export default {
  title: 'Components/Icons/PhIconArrowElbowUpRight',
  component: 'ph-icon-arrow-elbow-up-right',
  argTypes: {
    size: {
      control: 'select',
