...
import './ph-icon-arrow-fat-line-right.js';

export default {
  title: 'Components/Icons/PhIconArrowFatLineRight',
  component: 'ph-icon-arrow-fat-line-right',
  argTypes: {
    size: {
      control: 'select',
