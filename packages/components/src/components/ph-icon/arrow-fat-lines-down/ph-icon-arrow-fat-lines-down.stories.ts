...
import './ph-icon-arrow-fat-lines-down.js';

export default {
  title: 'Components/Icons/PhIconArrowFatLinesDown',
  component: 'ph-icon-arrow-fat-lines-down',
  argTypes: {
    size: {
      control: 'select',
