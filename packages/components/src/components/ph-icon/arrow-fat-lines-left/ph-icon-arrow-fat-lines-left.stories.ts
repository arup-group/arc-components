...
import './ph-icon-arrow-fat-lines-left.js';

export default {
  title: 'Components/Icons/PhIconArrowFatLinesLeft',
  component: 'ph-icon-arrow-fat-lines-left',
  argTypes: {
    size: {
      control: 'select',
