...
import './ph-icon-arrow-fat-lines-right.js';

export default {
  title: 'Components/Icons/PhIconArrowFatLinesRight',
  component: 'ph-icon-arrow-fat-lines-right',
  argTypes: {
    size: {
      control: 'select',
