...
import './ph-icon-arrow-line-down-left.js';

export default {
  title: 'Components/Icons/PhIconArrowLineDownLeft',
  component: 'ph-icon-arrow-line-down-left',
  argTypes: {
    size: {
      control: 'select',
