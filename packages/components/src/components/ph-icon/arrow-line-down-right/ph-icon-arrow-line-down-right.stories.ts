...
import './ph-icon-arrow-line-down-right.js';

export default {
  title: 'Components/Icons/PhIconArrowLineDownRight',
  component: 'ph-icon-arrow-line-down-right',
  argTypes: {
    size: {
      control: 'select',
