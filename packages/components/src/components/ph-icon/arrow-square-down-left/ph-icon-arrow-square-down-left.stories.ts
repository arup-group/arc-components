...
import './ph-icon-arrow-square-down-left.js';

export default {
  title: 'Components/Icons/PhIconArrowSquareDownLeft',
  component: 'ph-icon-arrow-square-down-left',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-square-down-left
