...
import './ph-icon-arrow-square-down-right.js';

export default {
  title: 'Components/Icons/PhIconArrowSquareDownRight',
  component: 'ph-icon-arrow-square-down-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrow-square-down-right
