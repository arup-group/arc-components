...
import './ph-icon-arrow-square-up-left.js';

export default {
  title: 'Components/Icons/PhIconArrowSquareUpLeft',
  component: 'ph-icon-arrow-square-up-left',
  argTypes: {
    size: {
      control: 'select',
