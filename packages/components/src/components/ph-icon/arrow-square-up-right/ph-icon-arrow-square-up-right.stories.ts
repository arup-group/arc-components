...
import './ph-icon-arrow-square-up-right.js';

export default {
  title: 'Components/Icons/PhIconArrowSquareUpRight',
  component: 'ph-icon-arrow-square-up-right',
  argTypes: {
    size: {
      control: 'select',
