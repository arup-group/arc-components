...
import './ph-icon-arrows-in-line-horizontal.js';

export default {
  title: 'Components/Icons/PhIconArrowsInLineHorizontal',
  component: 'ph-icon-arrows-in-line-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrows-in-line-horizontal
