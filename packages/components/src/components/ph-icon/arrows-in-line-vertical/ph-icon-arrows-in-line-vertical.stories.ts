...
import './ph-icon-arrows-in-line-vertical.js';

export default {
  title: 'Components/Icons/PhIconArrowsInLineVertical',
  component: 'ph-icon-arrows-in-line-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrows-in-line-vertical
