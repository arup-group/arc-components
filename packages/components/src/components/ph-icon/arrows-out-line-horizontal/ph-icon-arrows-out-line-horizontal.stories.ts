...
import './ph-icon-arrows-out-line-horizontal.js';

export default {
  title: 'Components/Icons/PhIconArrowsOutLineHorizontal',
  component: 'ph-icon-arrows-out-line-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrows-out-line-horizontal
