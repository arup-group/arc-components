...
import './ph-icon-arrows-out-line-vertical.js';

export default {
  title: 'Components/Icons/PhIconArrowsOutLineVertical',
  component: 'ph-icon-arrows-out-line-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-arrows-out-line-vertical
