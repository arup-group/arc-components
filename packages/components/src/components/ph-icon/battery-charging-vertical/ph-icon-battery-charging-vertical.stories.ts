...
import './ph-icon-battery-charging-vertical.js';

export default {
  title: 'Components/Icons/PhIconBatteryChargingVertical',
  component: 'ph-icon-battery-charging-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-battery-charging-vertical
