...
import './ph-icon-battery-plus-vertical.js';

export default {
  title: 'Components/Icons/PhIconBatteryPlusVertical',
  component: 'ph-icon-battery-plus-vertical',
  argTypes: {
    size: {
      control: 'select',
