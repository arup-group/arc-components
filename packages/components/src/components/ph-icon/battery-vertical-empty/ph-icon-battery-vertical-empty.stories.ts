...
import './ph-icon-battery-vertical-empty.js';

export default {
  title: 'Components/Icons/PhIconBatteryVerticalEmpty',
  component: 'ph-icon-battery-vertical-empty',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-battery-vertical-empty
