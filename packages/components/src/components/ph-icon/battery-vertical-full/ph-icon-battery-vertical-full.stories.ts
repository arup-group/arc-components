...
import './ph-icon-battery-vertical-full.js';

export default {
  title: 'Components/Icons/PhIconBatteryVerticalFull',
  component: 'ph-icon-battery-vertical-full',
  argTypes: {
    size: {
      control: 'select',
