...
import './ph-icon-battery-vertical-high.js';

export default {
  title: 'Components/Icons/PhIconBatteryVerticalHigh',
  component: 'ph-icon-battery-vertical-high',
  argTypes: {
    size: {
      control: 'select',
