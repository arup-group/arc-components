...
import './ph-icon-battery-vertical-low.js';

export default {
  title: 'Components/Icons/PhIconBatteryVerticalLow',
  component: 'ph-icon-battery-vertical-low',
  argTypes: {
    size: {
      control: 'select',
