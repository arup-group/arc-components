...
import './ph-icon-battery-vertical-medium.js';

export default {
  title: 'Components/Icons/PhIconBatteryVerticalMedium',
  component: 'ph-icon-battery-vertical-medium',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-battery-vertical-medium
