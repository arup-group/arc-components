...
export default class PhIconBatteryVerticalMedium extends LitElement {
  ...
  protected render() {
    return html`
      ...
      >
        ${PhIconBatteryVerticalMedium.svg}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-battery-vertical-medium': PhIconBatteryVerticalMedium;
  }
}
