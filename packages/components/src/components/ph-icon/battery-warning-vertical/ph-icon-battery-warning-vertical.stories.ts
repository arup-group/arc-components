...
import './ph-icon-battery-warning-vertical.js';

export default {
  title: 'Components/Icons/PhIconBatteryWarningVertical',
  component: 'ph-icon-battery-warning-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-battery-warning-vertical
