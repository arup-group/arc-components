 ...
 */
@customElement('ph-icon-bell-simple-slash')
export default class PhIconBellSimpleSlash extends LitElement {
  /** @internal */
  static tag = 'ph-icon-bell-simple-slash';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-bell-simple-slash': PhIconBellSimpleSlash;
  }
}
