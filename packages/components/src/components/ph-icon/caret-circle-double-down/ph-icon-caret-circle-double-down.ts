 ...
 * @ssr - True
 */
@customElement('ph-icon-caret-circle-double-down')
export default class PhIconCaretCircleDoubleDown extends LitElement {
  /** @internal */
  static tag = 'ph-icon-caret-circle-double-down';
  ...
  protected render() {
    return html`
      ...
      >
        ${PhIconCaretCircleDoubleDown.svg}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-caret-circle-double-down': PhIconCaretCircleDoubleDown;
  }
}
