...
import './ph-icon-caret-circle-double-left.js';

export default {
  title: 'Components/Icons/PhIconCaretCircleDoubleLeft',
  component: 'ph-icon-caret-circle-double-left',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-caret-circle-double-left
