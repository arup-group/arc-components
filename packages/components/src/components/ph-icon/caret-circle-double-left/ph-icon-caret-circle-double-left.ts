 ...
 */
@customElement('ph-icon-caret-circle-double-left')
export default class PhIconCaretCircleDoubleLeft extends LitElement {
  /** @internal */
  static tag = 'ph-icon-caret-circle-double-left';
  ...
  protected render() {
    return html`
      ...
      >
        ${PhIconCaretCircleDoubleLeft.svg}
      </svg>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-caret-circle-double-left': PhIconCaretCircleDoubleLeft;
  }
}
