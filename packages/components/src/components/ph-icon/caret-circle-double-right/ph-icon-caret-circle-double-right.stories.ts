...
import './ph-icon-caret-circle-double-right.js';

export default {
  title: 'Components/Icons/PhIconCaretCircleDoubleRight',
  component: 'ph-icon-caret-circle-double-right',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-caret-circle-double-right
