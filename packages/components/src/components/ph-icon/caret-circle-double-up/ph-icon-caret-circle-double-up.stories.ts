...
import './ph-icon-caret-circle-double-up.js';

export default {
  title: 'Components/Icons/PhIconCaretCircleDoubleUp',
  component: 'ph-icon-caret-circle-double-up',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-caret-circle-double-up
