 ...
 */
@customElement('ph-icon-caret-circle-up-down')
export default class PhIconCaretCircleUpDown extends LitElement {
  /** @internal */
  static tag = 'ph-icon-caret-circle-up-down';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-caret-circle-up-down': PhIconCaretCircleUpDown;
  }
}
