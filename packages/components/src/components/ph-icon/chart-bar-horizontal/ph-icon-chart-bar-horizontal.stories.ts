...
import './ph-icon-chart-bar-horizontal.js';

export default {
  title: 'Components/Icons/PhIconChartBarHorizontal',
  component: 'ph-icon-chart-bar-horizontal',
  argTypes: {
    size: {
      control: 'select',
