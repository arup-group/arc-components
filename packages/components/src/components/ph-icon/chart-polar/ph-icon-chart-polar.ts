 ...
 * @ssr - True
 */
@customElement('ph-icon-chart-polar')
export default class PhIconChartPolar extends LitElement {
  /** @internal */
  static tag = 'ph-icon-chart-polar';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-chart-polar': PhIconChartPolar;
  }
}
