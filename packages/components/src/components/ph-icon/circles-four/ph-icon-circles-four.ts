 ...
 * @ssr - True
 */
@customElement('ph-icon-circles-four')
export default class PhIconCirclesFour extends LitElement {
  /** @internal */
  static tag = 'ph-icon-circles-four';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-circles-four': PhIconCirclesFour;
  }
}
