...
import './ph-icon-clock-counter-clockwise.js';

export default {
  title: 'Components/Icons/PhIconClockCounterClockwise',
  component: 'ph-icon-clock-counter-clockwise',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-clock-counter-clockwise
