 ...
 * @ssr - True
 */
@customElement('ph-icon-crosshair-simple')
export default class PhIconCrosshairSimple extends LitElement {
  /** @internal */
  static tag = 'ph-icon-crosshair-simple';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-crosshair-simple': PhIconCrosshairSimple;
  }
}
