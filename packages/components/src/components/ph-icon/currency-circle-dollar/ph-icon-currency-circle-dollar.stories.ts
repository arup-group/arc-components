...
import './ph-icon-currency-circle-dollar.js';

export default {
  title: 'Components/Icons/PhIconCurrencyCircleDollar',
  component: 'ph-icon-currency-circle-dollar',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-currency-circle-dollar
