...
import './ph-icon-currency-dollar-simple.js';

export default {
  title: 'Components/Icons/PhIconCurrencyDollarSimple',
  component: 'ph-icon-currency-dollar-simple',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-currency-dollar-simple
