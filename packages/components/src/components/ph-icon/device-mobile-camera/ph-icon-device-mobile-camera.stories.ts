...
import './ph-icon-device-mobile-camera.js';

export default {
  title: 'Components/Icons/PhIconDeviceMobileCamera',
  component: 'ph-icon-device-mobile-camera',
  argTypes: {
    size: {
      control: 'select',
