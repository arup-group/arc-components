...
import './ph-icon-device-mobile-speaker.js';

export default {
  title: 'Components/Icons/PhIconDeviceMobileSpeaker',
  component: 'ph-icon-device-mobile-speaker',
  argTypes: {
    size: {
      control: 'select',
