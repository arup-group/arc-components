...
import './ph-icon-device-tablet-camera.js';

export default {
  title: 'Components/Icons/PhIconDeviceTabletCamera',
  component: 'ph-icon-device-tablet-camera',
  argTypes: {
    size: {
      control: 'select',
