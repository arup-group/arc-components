...
import './ph-icon-device-tablet-speaker.js';

export default {
  title: 'Components/Icons/PhIconDeviceTabletSpeaker',
  component: 'ph-icon-device-tablet-speaker',
  argTypes: {
    size: {
      control: 'select',
