 ...
 * @ssr - True
 */
@customElement('ph-icon-dice-three')
export default class PhIconDiceThree extends LitElement {
  /** @internal */
  static tag = 'ph-icon-dice-three';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-dice-three': PhIconDiceThree;
  }
}
