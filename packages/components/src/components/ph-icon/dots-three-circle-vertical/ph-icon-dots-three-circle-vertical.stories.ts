...
import './ph-icon-dots-three-circle-vertical.js';

export default {
  title: 'Components/Icons/PhIconDotsThreeCircleVertical',
  component: 'ph-icon-dots-three-circle-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-dots-three-circle-vertical
