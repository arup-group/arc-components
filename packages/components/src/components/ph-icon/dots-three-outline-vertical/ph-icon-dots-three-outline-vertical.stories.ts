...
import './ph-icon-dots-three-outline-vertical.js';

export default {
  title: 'Components/Icons/PhIconDotsThreeOutlineVertical',
  component: 'ph-icon-dots-three-outline-vertical',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-dots-three-outline-vertical
