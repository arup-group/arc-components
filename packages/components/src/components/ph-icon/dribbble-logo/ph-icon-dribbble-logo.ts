 ...
 * @ssr - True
 */
@customElement('ph-icon-dribbble-logo')
export default class PhIconDribbbleLogo extends LitElement {
  /** @internal */
  static tag = 'ph-icon-dribbble-logo';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-dribbble-logo': PhIconDribbbleLogo;
  }
}
