...
import './ph-icon-envelope-simple-open.js';

export default {
  title: 'Components/Icons/PhIconEnvelopeSimpleOpen',
  component: 'ph-icon-envelope-simple-open',
  argTypes: {
    size: {
      control: 'select',
