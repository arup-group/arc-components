 ...
 */
@customElement('ph-icon-fast-forward-circle')
export default class PhIconFastForwardCircle extends LitElement {
  /** @internal */
  static tag = 'ph-icon-fast-forward-circle';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-fast-forward-circle': PhIconFastForwardCircle;
  }
}
