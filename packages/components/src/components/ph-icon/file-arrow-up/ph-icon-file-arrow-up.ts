 ...
 */
@customElement('ph-icon-file-arrow-up')
export default class PhIconFileArrowUp extends LitElement {
  /** @internal */
  static tag = 'ph-icon-file-arrow-up';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-file-arrow-up': PhIconFileArrowUp;
  }
}
