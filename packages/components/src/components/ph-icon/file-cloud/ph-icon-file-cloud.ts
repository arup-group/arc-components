 ...
 * @ssr - True
 */
@customElement('ph-icon-file-cloud')
export default class PhIconFileCloud extends LitElement {
  /** @internal */
  static tag = 'ph-icon-file-cloud';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-file-cloud': PhIconFileCloud;
  }
}
