...
import './ph-icon-file-magnifying-glass.js';

export default {
  title: 'Components/Icons/PhIconFileMagnifyingGlass',
  component: 'ph-icon-file-magnifying-glass',
  argTypes: {
    size: {
      control: 'select',
