 ...
 */
@customElement('ph-icon-file-magnifying-glass')
export default class PhIconFileMagnifyingGlass extends LitElement {
  /** @internal */
  static tag = 'ph-icon-file-magnifying-glass';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-file-magnifying-glass': PhIconFileMagnifyingGlass;
  }
}
