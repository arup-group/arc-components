 ...
 */
@customElement('ph-icon-folder-open')
export default class PhIconFolderOpen extends LitElement {
  /** @internal */
  static tag = 'ph-icon-folder-open';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-folder-open': PhIconFolderOpen;
  }
}
