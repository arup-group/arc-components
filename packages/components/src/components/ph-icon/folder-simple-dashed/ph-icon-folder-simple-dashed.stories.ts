...
import './ph-icon-folder-simple-dashed.js';

export default {
  title: 'Components/Icons/PhIconFolderSimpleDashed',
  component: 'ph-icon-folder-simple-dashed',
  argTypes: {
    size: {
      control: 'select',
