 ...
 */
@customElement('ph-icon-folder-user')
export default class PhIconFolderUser extends LitElement {
  /** @internal */
  static tag = 'ph-icon-folder-user';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-folder-user': PhIconFolderUser;
  }
}
