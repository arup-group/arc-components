...
import './ph-icon-globe-hemisphere-east.js';

export default {
  title: 'Components/Icons/PhIconGlobeHemisphereEast',
  component: 'ph-icon-globe-hemisphere-east',
  argTypes: {
    size: {
      control: 'select',
