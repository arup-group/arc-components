 ...
 * @ssr - True
 */
@customElement('ph-icon-globe-hemisphere-east')
export default class PhIconGlobeHemisphereEast extends LitElement {
  /** @internal */
  static tag = 'ph-icon-globe-hemisphere-east';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-globe-hemisphere-east': PhIconGlobeHemisphereEast;
  }
}
