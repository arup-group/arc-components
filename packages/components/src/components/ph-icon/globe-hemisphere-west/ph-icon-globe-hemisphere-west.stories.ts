...
import './ph-icon-globe-hemisphere-west.js';

export default {
  title: 'Components/Icons/PhIconGlobeHemisphereWest',
  component: 'ph-icon-globe-hemisphere-west',
  argTypes: {
    size: {
      control: 'select',
