...
import './ph-icon-google-cardboard-logo.js';

export default {
  title: 'Components/Icons/PhIconGoogleCardboardLogo',
  component: 'ph-icon-google-cardboard-logo',
  argTypes: {
    size: {
      control: 'select',
