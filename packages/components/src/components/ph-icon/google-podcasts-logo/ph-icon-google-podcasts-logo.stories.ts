...
import './ph-icon-google-podcasts-logo.js';

export default {
  title: 'Components/Icons/PhIconGooglePodcastsLogo',
  component: 'ph-icon-google-podcasts-logo',
  argTypes: {
    size: {
      control: 'select',
