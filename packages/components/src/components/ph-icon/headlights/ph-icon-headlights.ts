 ...
 * @ssr - True
 */
@customElement('ph-icon-headlights')
export default class PhIconHeadlights extends LitElement {
  /** @internal */
  static tag = 'ph-icon-headlights';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-headlights': PhIconHeadlights;
  }
}
