...
import './ph-icon-heart-straight-break.js';

export default {
  title: 'Components/Icons/PhIconHeartStraightBreak',
  component: 'ph-icon-heart-straight-break',
  argTypes: {
    size: {
      control: 'select',
