...
import './ph-icon-hourglass-simple-high.js';

export default {
  title: 'Components/Icons/PhIconHourglassSimpleHigh',
  component: 'ph-icon-hourglass-simple-high',
  argTypes: {
    size: {
      control: 'select',
