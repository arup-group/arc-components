...
import './ph-icon-hourglass-simple-low.js';

export default {
  title: 'Components/Icons/PhIconHourglassSimpleLow',
  component: 'ph-icon-hourglass-simple-low',
  argTypes: {
    size: {
      control: 'select',
