...
import './ph-icon-hourglass-simple-medium.js';

export default {
  title: 'Components/Icons/PhIconHourglassSimpleMedium',
  component: 'ph-icon-hourglass-simple-medium',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-hourglass-simple-medium
