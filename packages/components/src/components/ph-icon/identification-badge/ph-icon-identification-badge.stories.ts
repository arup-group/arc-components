...
import './ph-icon-identification-badge.js';

export default {
  title: 'Components/Icons/PhIconIdentificationBadge',
  component: 'ph-icon-identification-badge',
  argTypes: {
    size: {
      control: 'select',
