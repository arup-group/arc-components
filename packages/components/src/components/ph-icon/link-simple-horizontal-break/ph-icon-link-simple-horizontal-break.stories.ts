...
import './ph-icon-link-simple-horizontal-break.js';

export default {
  title: 'Components/Icons/PhIconLinkSimpleHorizontalBreak',
  component: 'ph-icon-link-simple-horizontal-break',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-link-simple-horizontal-break
