...
import './ph-icon-link-simple-horizontal.js';

export default {
  title: 'Components/Icons/PhIconLinkSimpleHorizontal',
  component: 'ph-icon-link-simple-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-link-simple-horizontal
