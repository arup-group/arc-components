...
import './ph-icon-list-magnifying-glass.js';

export default {
  title: 'Components/Icons/PhIconListMagnifyingGlass',
  component: 'ph-icon-list-magnifying-glass',
  argTypes: {
    size: {
      control: 'select',
