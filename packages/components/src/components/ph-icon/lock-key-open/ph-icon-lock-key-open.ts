 ...
 */
@customElement('ph-icon-lock-key-open')
export default class PhIconLockKeyOpen extends LitElement {
  /** @internal */
  static tag = 'ph-icon-lock-key-open';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-lock-key-open': PhIconLockKeyOpen;
  }
}
