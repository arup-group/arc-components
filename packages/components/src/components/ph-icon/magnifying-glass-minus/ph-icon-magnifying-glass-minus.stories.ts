...
import './ph-icon-magnifying-glass-minus.js';

export default {
  title: 'Components/Icons/PhIconMagnifyingGlassMinus',
  component: 'ph-icon-magnifying-glass-minus',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-magnifying-glass-minus
