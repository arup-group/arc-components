...
import './ph-icon-magnifying-glass-plus.js';

export default {
  title: 'Components/Icons/PhIconMagnifyingGlassPlus',
  component: 'ph-icon-magnifying-glass-plus',
  argTypes: {
    size: {
      control: 'select',
