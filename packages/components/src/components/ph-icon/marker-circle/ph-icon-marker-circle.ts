 ...
 */
@customElement('ph-icon-marker-circle')
export default class PhIconMarkerCircle extends LitElement {
  /** @internal */
  static tag = 'ph-icon-marker-circle';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-marker-circle': PhIconMarkerCircle;
  }
}
