...
import './ph-icon-microsoft-excel-logo.js';

export default {
  title: 'Components/Icons/PhIconMicrosoftExcelLogo',
  component: 'ph-icon-microsoft-excel-logo',
  argTypes: {
    size: {
      control: 'select',
