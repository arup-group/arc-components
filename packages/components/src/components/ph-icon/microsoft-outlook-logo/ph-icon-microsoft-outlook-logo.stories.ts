...
import './ph-icon-microsoft-outlook-logo.js';

export default {
  title: 'Components/Icons/PhIconMicrosoftOutlookLogo',
  component: 'ph-icon-microsoft-outlook-logo',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-microsoft-outlook-logo
