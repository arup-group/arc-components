...
import './ph-icon-microsoft-powerpoint-logo.js';

export default {
  title: 'Components/Icons/PhIconMicrosoftPowerpointLogo',
  component: 'ph-icon-microsoft-powerpoint-logo',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-microsoft-powerpoint-logo
