...
import './ph-icon-microsoft-teams-logo.js';

export default {
  title: 'Components/Icons/PhIconMicrosoftTeamsLogo',
  component: 'ph-icon-microsoft-teams-logo',
  argTypes: {
    size: {
      control: 'select',
