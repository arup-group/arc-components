 ...
 * @ssr - True
 */
@customElement('ph-icon-number-circle-five')
export default class PhIconNumberCircleFive extends LitElement {
  /** @internal */
  static tag = 'ph-icon-number-circle-five';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-number-circle-five': PhIconNumberCircleFive;
  }
}
