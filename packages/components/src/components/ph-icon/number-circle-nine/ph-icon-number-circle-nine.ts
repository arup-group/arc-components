 ...
 * @ssr - True
 */
@customElement('ph-icon-number-circle-nine')
export default class PhIconNumberCircleNine extends LitElement {
  /** @internal */
  static tag = 'ph-icon-number-circle-nine';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-number-circle-nine': PhIconNumberCircleNine;
  }
}
