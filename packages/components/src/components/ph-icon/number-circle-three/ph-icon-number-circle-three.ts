 ...
 */
@customElement('ph-icon-number-circle-three')
export default class PhIconNumberCircleThree extends LitElement {
  /** @internal */
  static tag = 'ph-icon-number-circle-three';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-number-circle-three': PhIconNumberCircleThree;
  }
}
