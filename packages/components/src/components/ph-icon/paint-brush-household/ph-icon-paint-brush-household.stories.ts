...
import './ph-icon-paint-brush-household.js';

export default {
  title: 'Components/Icons/PhIconPaintBrushHousehold',
  component: 'ph-icon-paint-brush-household',
  argTypes: {
    size: {
      control: 'select',
