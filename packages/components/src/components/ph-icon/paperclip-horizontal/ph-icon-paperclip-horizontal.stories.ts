...
import './ph-icon-paperclip-horizontal.js';

export default {
  title: 'Components/Icons/PhIconPaperclipHorizontal',
  component: 'ph-icon-paperclip-horizontal',
  argTypes: {
    size: {
      control: 'select',
