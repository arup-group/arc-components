...
import './ph-icon-projector-screen-chart.js';

export default {
  title: 'Components/Icons/PhIconProjectorScreenChart',
  component: 'ph-icon-projector-screen-chart',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-projector-screen-chart
