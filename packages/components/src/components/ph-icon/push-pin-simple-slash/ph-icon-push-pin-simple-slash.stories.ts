...
import './ph-icon-push-pin-simple-slash.js';

export default {
  title: 'Components/Icons/PhIconPushPinSimpleSlash',
  component: 'ph-icon-push-pin-simple-slash',
  argTypes: {
    size: {
      control: 'select',
