 ...
 */
@customElement('ph-icon-rewind-circle')
export default class PhIconRewindCircle extends LitElement {
  /** @internal */
  static tag = 'ph-icon-rewind-circle';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-rewind-circle': PhIconRewindCircle;
  }
}
