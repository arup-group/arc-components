...
import './ph-icon-selection-foreground.js';

export default {
  title: 'Components/Icons/PhIconSelectionForeground',
  component: 'ph-icon-selection-foreground',
  argTypes: {
    size: {
      control: 'select',
