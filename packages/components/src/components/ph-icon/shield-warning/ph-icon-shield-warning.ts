 ...
 * @ssr - True
 */
@customElement('ph-icon-shield-warning')
export default class PhIconShieldWarning extends LitElement {
  /** @internal */
  static tag = 'ph-icon-shield-warning';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-shield-warning': PhIconShieldWarning;
  }
}
