...
import './ph-icon-shopping-cart-simple.js';

export default {
  title: 'Components/Icons/PhIconShoppingCartSimple',
  component: 'ph-icon-shopping-cart-simple',
  argTypes: {
    size: {
      control: 'select',
