 ...
 */
@customElement('ph-icon-smiley-sad')
export default class PhIconSmileySad extends LitElement {
  /** @internal */
  static tag = 'ph-icon-smiley-sad';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-smiley-sad': PhIconSmileySad;
  }
}
