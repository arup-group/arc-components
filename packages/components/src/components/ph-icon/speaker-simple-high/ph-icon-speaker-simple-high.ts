 ...
 */
@customElement('ph-icon-speaker-simple-high')
export default class PhIconSpeakerSimpleHigh extends LitElement {
  /** @internal */
  static tag = 'ph-icon-speaker-simple-high';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-speaker-simple-high': PhIconSpeakerSimpleHigh;
  }
}
