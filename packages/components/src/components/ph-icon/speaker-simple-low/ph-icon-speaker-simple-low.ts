 ...
 * @ssr - True
 */
@customElement('ph-icon-speaker-simple-low')
export default class PhIconSpeakerSimpleLow extends LitElement {
  /** @internal */
  static tag = 'ph-icon-speaker-simple-low';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-speaker-simple-low': PhIconSpeakerSimpleLow;
  }
}
