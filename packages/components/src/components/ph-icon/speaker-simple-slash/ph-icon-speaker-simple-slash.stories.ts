...
import './ph-icon-speaker-simple-slash.js';

export default {
  title: 'Components/Icons/PhIconSpeakerSimpleSlash',
  component: 'ph-icon-speaker-simple-slash',
  argTypes: {
    size: {
      control: 'select',
