...
import './ph-icon-square-split-horizontal.js';

export default {
  title: 'Components/Icons/PhIconSquareSplitHorizontal',
  component: 'ph-icon-square-split-horizontal',
  argTypes: {
    size: {
      control: 'select',
...
const Template: Story<ArcIcon> = ({ label, size, rotation }) => html`
  <ph-icon-square-split-horizontal
