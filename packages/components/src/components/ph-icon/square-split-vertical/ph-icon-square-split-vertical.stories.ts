...
import './ph-icon-square-split-vertical.js';

export default {
  title: 'Components/Icons/PhIconSquareSplitVertical',
  component: 'ph-icon-square-split-vertical',
  argTypes: {
    size: {
      control: 'select',
