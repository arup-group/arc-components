...
import './ph-icon-trademark-registered.js';

export default {
  title: 'Components/Icons/PhIconTrademarkRegistered',
  component: 'ph-icon-trademark-registered',
  argTypes: {
    size: {
      control: 'select',
