 ...
 */
@customElement('ph-icon-user-circle-minus')
export default class PhIconUserCircleMinus extends LitElement {
  /** @internal */
  static tag = 'ph-icon-user-circle-minus';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-user-circle-minus': PhIconUserCircleMinus;
  }
}
