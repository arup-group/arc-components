 ...
 * @ssr - True
 */
@customElement('ph-icon-vinyl-record')
export default class PhIconVinylRecord extends LitElement {
  /** @internal */
  static tag = 'ph-icon-vinyl-record';
...
declare global {
  interface HTMLElementTagNameMap {
    'ph-icon-vinyl-record': PhIconVinylRecord;
  }
}
