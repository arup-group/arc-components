...
> **Note**: More information on this, can be found on the official [GridJS](https://gridjs.io/docs/examples/cell-formatting) docs.
...
> **Note**: More information on the available options and how to manage them,
can be found on the official [GridJS](https://gridjs.io/docs/examples/cell-formatting) docs.
