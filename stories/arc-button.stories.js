...
import { BUTTON_COLORS, BUTTON_SIZES, BUTTON_TYPES, } from '../src/components/button/constants/ButtonConstants.js';
const Template = ({ label, type, color, size, href, target, download, active, disabled, loading, submit, width, minWidth, btnColor, btnBackground, prefix, suffix, }) => html `
  <arc-button
