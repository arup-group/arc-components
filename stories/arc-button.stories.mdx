...
Keep in mind that the semantics of a button should not be defined by the color.
It is highly recommended to use only the Primary and Secondary colors for buttons on the page.
