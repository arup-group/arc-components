...
argTypes={{
    placement: {
      ...
      defaultValue: { summary: DROPDOWN_PLACEMENTS['bottom-start'] },
      control: { type: 'select' },
...
The ArcDropdown is used to expose additional content that 'drops down' in a panel.
Dropdowns consist of a trigger and a panel. By default, activating the trigger will expose the panel and interacting outside of the panel will close it.

Dropdowns are designed to work well with the [arc-menu](?path=/story/arcmenu--default) to provide a list of options to the user.
...
| Name           | Description                                                       |
|----------------|-------------------------------------------------------------------|
| arc-show       | Emitted when the dropdown opens.                                  |
| arc-after-show | Emitted after the dropdown opens and all animations are complete. |
| arc-hide       | Emitted when the dropdown closes.                                 |
