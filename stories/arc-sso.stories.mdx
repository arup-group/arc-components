...
## Authenticating
### SignIn
By default, the component provides a simple [arc-button](?path=/story/arcbutton--default) component with the `type=tab` property.
...
### SignOut
By default, component provides an [arc-dropdown](?path=/story/arcdropdown--default) component
that displays your username and provides a single item that allows you to sign out.
